...
-/
def restricted_yoneda {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) : ℰ ⥤ Cᵒᵖ ⥤ Type u₁ :=
...
def restricted_yoneda_yoneda {C : Type u₁} [small_category C] : restricted_yoneda yoneda ≅ 𝟭 :=
  nat_iso.of_components
    (fun (P : Cᵒᵖ ⥤ Type u₁) => nat_iso.of_components (fun (X : Cᵒᵖ) => yoneda_sections_small (opposite.unop X) P) sorry)
    sorry
...
-/
def restrict_yoneda_hom_equiv {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) (P : Cᵒᵖ ⥤ Type u₁) (E : ℰ) {c : limits.cocone (functor.left_op (category_of_elements.π P) ⋙ A)} (t : limits.is_colimit c) : (limits.cocone.X c ⟶ E) ≃ (P ⟶ functor.obj (restricted_yoneda A) E) :=
  equiv.trans (iso.to_equiv (limits.is_colimit.hom_iso' t E))
    (equiv.mk
      (fun
        (k :
        Subtype
          fun (p : (j : functor.elements Pᵒᵖ) → functor.obj (functor.left_op (category_of_elements.π P) ⋙ A) j ⟶ E) =>
            ∀ {j j' : functor.elements Pᵒᵖ} (f : j ⟶ j'),
              functor.map (functor.left_op (category_of_elements.π P) ⋙ A) f ≫ p j' = p j) =>
        nat_trans.mk fun (c : Cᵒᵖ) (p : functor.obj P c) => subtype.val k (opposite.op (sigma.mk c p)))
      (fun (τ : P ⟶ functor.obj (restricted_yoneda A) E) =>
        { val :=
            fun (p : functor.elements Pᵒᵖ) => nat_trans.app τ (sigma.fst (opposite.unop p)) (sigma.snd (opposite.unop p)),
          property := sorry })
      sorry sorry)
...
-/
theorem restrict_yoneda_hom_equiv_natural {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) (P : Cᵒᵖ ⥤ Type u₁) (E₁ : ℰ) (E₂ : ℰ) (g : E₁ ⟶ E₂) {c : limits.cocone (functor.left_op (category_of_elements.π P) ⋙ A)} (t : limits.is_colimit c) (k : limits.cocone.X c ⟶ E₁) : coe_fn (restrict_yoneda_hom_equiv A P E₂ t) (k ≫ g) =
  coe_fn (restrict_yoneda_hom_equiv A P E₁ t) k ≫ functor.map (restricted_yoneda A) g := sorry
...
-/
def extend_along_yoneda {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) [limits.has_colimits ℰ] : (Cᵒᵖ ⥤ Type u₁) ⥤ ℰ :=
  adjunction.left_adjoint_of_equiv
    (fun (P : Cᵒᵖ ⥤ Type u₁) (E : ℰ) =>
      restrict_yoneda_hom_equiv A P E (limits.colimit.is_colimit (functor.left_op (category_of_elements.π P) ⋙ A)))
    sorry

@[simp] theorem extend_along_yoneda_obj {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) [limits.has_colimits ℰ] (P : Cᵒᵖ ⥤ Type u₁) : functor.obj (extend_along_yoneda A) P = limits.colimit (functor.left_op (category_of_elements.π P) ⋙ A) :=
  rfl
...
-/
def yoneda_adjunction {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) [limits.has_colimits ℰ] : extend_along_yoneda A ⊣ restricted_yoneda A :=
...
-/
def elements.initial {C : Type u₁} [small_category C] (A : C) : functor.elements (functor.obj yoneda A) :=
...
-/
def is_extension_along_yoneda {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) [limits.has_colimits ℰ] : yoneda ⋙ extend_along_yoneda A ≅ A :=
  nat_iso.of_components
    (fun (X : C) =>
      limits.is_colimit.cocone_point_unique_up_to_iso
        (limits.colimit.is_colimit (functor.left_op (category_of_elements.π (functor.obj yoneda X)) ⋙ A))
...
protected instance extend_along_yoneda.category_theory.limits.preserves_colimits {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) [limits.has_colimits ℰ] : limits.preserves_colimits (extend_along_yoneda A) :=
...
-/
def extend_along_yoneda_yoneda {C : Type u₁} [small_category C] : colimit_adj.extend_along_yoneda yoneda ≅ 𝟭 :=
...
def functor_to_representables {C : Type u₁} [small_category C] (P : Cᵒᵖ ⥤ Type u₁) : functor.elements Pᵒᵖ ⥤ Cᵒᵖ ⥤ Type u₁ :=
...
-/
def cocone_of_representable {C : Type u₁} [small_category C] (P : Cᵒᵖ ⥤ Type u₁) : limits.cocone (functor_to_representables P) :=
  limits.cocone.extend (limits.colimit.cocone (functor_to_representables P))
    (nat_trans.app (iso.hom extend_along_yoneda_yoneda) P)

@[simp] theorem cocone_of_representable_X {C : Type u₁} [small_category C] (P : Cᵒᵖ ⥤ Type u₁) : limits.cocone.X (cocone_of_representable P) = P :=
  rfl
...
theorem cocone_of_representable_ι_app {C : Type u₁} [small_category C] (P : Cᵒᵖ ⥤ Type u₁) (j : functor.elements Pᵒᵖ) : nat_trans.app (limits.cocone.ι (cocone_of_representable P)) j =
  iso.inv
    (yoneda_sections_small (functor.obj (functor.left_op (category_of_elements.π P)) j)
      (functor.obj (functor.obj (functor.const (functor.elements Pᵒᵖ)) (limits.cocone.X (cocone_of_representable P)))
        j))
    (sigma.snd (opposite.unop j)) := sorry

/-- The legs of the cocone `cocone_of_representable` are natural in the choice of presheaf. -/
theorem cocone_of_representable_naturality {C : Type u₁} [small_category C] {P₁ : Cᵒᵖ ⥤ Type u₁} {P₂ : Cᵒᵖ ⥤ Type u₁} (α : P₁ ⟶ P₂) (j : functor.elements P₁ᵒᵖ) : nat_trans.app (limits.cocone.ι (cocone_of_representable P₁)) j ≫ α =
  nat_trans.app (limits.cocone.ι (cocone_of_representable P₂)) (functor.obj (functor.op (category_of_elements.map α)) j) := sorry
...
-/
def colimit_of_representable {C : Type u₁} [small_category C] (P : Cᵒᵖ ⥤ Type u₁) : limits.is_colimit (cocone_of_representable P) :=
...
-/
def nat_iso_of_nat_iso_on_representables {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (L₁ : (Cᵒᵖ ⥤ Type u₁) ⥤ ℰ) (L₂ : (Cᵒᵖ ⥤ Type u₁) ⥤ ℰ) [limits.preserves_colimits L₁] [limits.preserves_colimits L₂] (h : yoneda ⋙ L₁ ≅ yoneda ⋙ L₂) : L₁ ≅ L₂ :=
  nat_iso.of_components
    (fun (P : Cᵒᵖ ⥤ Type u₁) =>
      limits.is_colimit.cocone_points_iso_of_nat_iso (limits.is_colimit_of_preserves L₁ (colimit_of_representable P))
...
-/
def unique_extension_along_yoneda {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] (A : C ⥤ ℰ) [limits.has_colimits ℰ] (L : (Cᵒᵖ ⥤ Type u₁) ⥤ ℰ) (hL : yoneda ⋙ L ≅ A) [limits.preserves_colimits L] : L ≅ colimit_adj.extend_along_yoneda A :=
...
-/
def is_left_adjoint_of_preserves_colimits_aux {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] [limits.has_colimits ℰ] (L : (Cᵒᵖ ⥤ Type u₁) ⥤ ℰ) [limits.preserves_colimits L] : is_left_adjoint L :=
...
-/
def is_left_adjoint_of_preserves_colimits {C : Type u₁} [small_category C] {ℰ : Type u₂} [category ℰ] [limits.has_colimits ℰ] (L : (C ⥤ Type u₁) ⥤ ℰ) [limits.preserves_colimits L] : is_left_adjoint L :=
