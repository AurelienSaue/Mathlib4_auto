...
def list_equiv_dlist (α : Type u_1) : List α ≃ dlist α :=
  equiv.mk of_list to_list sorry sorry

protected instance traversable : traversable dlist :=
...
protected instance inhabited {α : Type u_1} : Inhabited (dlist α) :=
  { default := empty }
