...
protected def add_semigroup {M₁ : Type u_1} {M₂ : Type u_2} [Add M₁] [add_semigroup M₂] (f : M₁ → M₂) (hf : injective f) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_semigroup M₁ :=
...
protected def comm_semigroup {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₁] [comm_semigroup M₂] (f : M₁ → M₂) (hf : injective f) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) : comm_semigroup M₁ :=
...
protected def add_left_cancel_semigroup {M₁ : Type u_1} {M₂ : Type u_2} [Add M₁] [add_left_cancel_semigroup M₂] (f : M₁ → M₂) (hf : injective f) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_left_cancel_semigroup M₁ :=
...
protected def right_cancel_semigroup {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₁] [right_cancel_semigroup M₂] (f : M₁ → M₂) (hf : injective f) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) : right_cancel_semigroup M₁ :=
...
protected def add_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Add M₁] [HasZero M₁] [add_monoid M₂] (f : M₁ → M₂) (hf : injective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_monoid M₁ :=
...
protected def add_left_cancel_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Add M₁] [HasZero M₁] [add_left_cancel_monoid M₂] (f : M₁ → M₂) (hf : injective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_left_cancel_monoid M₁ :=
...
protected def add_comm_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Add M₁] [HasZero M₁] [add_comm_monoid M₂] (f : M₁ → M₂) (hf : injective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_comm_monoid M₁ :=
...
protected def div_inv_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₁] [HasOne M₁] [has_inv M₁] [Div M₁] [div_inv_monoid M₂] (f : M₁ → M₂) (hf : injective f) (one : f 1 = 1) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) (inv : ∀ (x : M₁), f (x⁻¹) = (f x⁻¹)) (div : ∀ (x y : M₁), f (x / y) = f x / f y) : div_inv_monoid M₁ :=
...
protected def group {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₁] [HasOne M₁] [has_inv M₁] [group M₂] (f : M₁ → M₂) (hf : injective f) (one : f 1 = 1) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) (inv : ∀ (x : M₁), f (x⁻¹) = (f x⁻¹)) : group M₁ :=
...
-/
protected def add_group_sub {M₁ : Type u_1} {M₂ : Type u_2} [Add M₁] [HasZero M₁] [Neg M₁] [Sub M₁] [add_group M₂] (f : M₁ → M₂) (hf : injective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) (inv : ∀ (x : M₁), f (-x) = -f x) (div : ∀ (x y : M₁), f (x - y) = f x - f y) : add_group M₁ :=
...
protected def comm_group {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₁] [HasOne M₁] [has_inv M₁] [comm_group M₂] (f : M₁ → M₂) (hf : injective f) (one : f 1 = 1) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) (inv : ∀ (x : M₁), f (x⁻¹) = (f x⁻¹)) : comm_group M₁ :=
...
to the specified division operator.
-/
protected def comm_group_div {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₁] [HasOne M₁] [has_inv M₁] [Div M₁] [comm_group M₂] (f : M₁ → M₂) (hf : injective f) (one : f 1 = 1) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) (inv : ∀ (x : M₁), f (x⁻¹) = (f x⁻¹)) (div : ∀ (x y : M₁), f (x / y) = f x / f y) : comm_group M₁ :=
  comm_group.mk comm_monoid.mul sorry comm_monoid.one sorry sorry group.inv group.div sorry sorry
...
protected def add_semigroup {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [add_semigroup M₁] (f : M₁ → M₂) (hf : surjective f) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_semigroup M₂ :=
  add_semigroup.mk Add.add sorry

/-- A type endowed with `*` is a commutative semigroup,
if it admits a surjective map that preserves `*` from a commutative semigroup. -/
protected def add_comm_semigroup {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [add_comm_semigroup M₁] (f : M₁ → M₂) (hf : surjective f) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_comm_semigroup M₂ :=
  add_comm_semigroup.mk add_semigroup.add sorry sorry

/-- A type endowed with `1` and `*` is a monoid,
if it admits a surjective map that preserves `1` and `*` from a monoid. -/
protected def add_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [HasZero M₂] [add_monoid M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_monoid M₂ :=
  add_monoid.mk add_semigroup.add sorry 0 sorry sorry

/-- A type endowed with `1` and `*` is a commutative monoid,
if it admits a surjective map that preserves `1` and `*` from a commutative monoid. -/
protected def add_comm_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [HasZero M₂] [add_comm_monoid M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) : add_comm_monoid M₂ :=
  add_comm_monoid.mk add_comm_semigroup.add sorry add_monoid.zero sorry sorry sorry

/-- A type endowed with `1`, `*` and `⁻¹` is a group,
if it admits a surjective map that preserves `1`, `*` and `⁻¹` from a group. -/
protected def group {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₂] [HasOne M₂] [has_inv M₂] [group M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 1 = 1) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) (inv : ∀ (x : M₁), f (x⁻¹) = (f x⁻¹)) : group M₂ :=
  group.mk monoid.mul sorry monoid.one sorry sorry has_inv.inv
    (div_inv_monoid.div._default monoid.mul sorry monoid.one sorry sorry has_inv.inv) sorry

/-- A type endowed with `1`, `*`, `⁻¹`, and `/` is a `div_inv_monoid`,
if it admits a surjective map that preserves `1`, `*`, `⁻¹`, and `/` from a `div_inv_monoid` -/
protected def sub_neg_add_monoid {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [HasZero M₂] [Neg M₂] [Sub M₂] [sub_neg_monoid M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) (inv : ∀ (x : M₁), f (-x) = -f x) (div : ∀ (x y : M₁), f (x - y) = f x - f y) : sub_neg_monoid M₂ :=
...
to the specified division operator.
-/
protected def add_group_sub {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [HasZero M₂] [Neg M₂] [Sub M₂] [add_group M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) (inv : ∀ (x : M₁), f (-x) = -f x) (div : ∀ (x y : M₁), f (x - y) = f x - f y) : add_group M₂ :=
  add_group.mk sub_neg_monoid.add sorry sub_neg_monoid.zero sorry sorry sub_neg_monoid.neg sub_neg_monoid.sub sorry

/-- A type endowed with `1`, `*` and `⁻¹` is a commutative group,
if it admits a surjective map that preserves `1`, `*` and `⁻¹` from a commutative group. -/
protected def comm_group {M₁ : Type u_1} {M₂ : Type u_2} [Mul M₂] [HasOne M₂] [has_inv M₂] [comm_group M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 1 = 1) (mul : ∀ (x y : M₁), f (x * y) = f x * f y) (inv : ∀ (x : M₁), f (x⁻¹) = (f x⁻¹)) : comm_group M₂ :=
  comm_group.mk comm_monoid.mul sorry comm_monoid.one sorry sorry group.inv group.div sorry sorry
...
to the specified division operator.
-/
protected def add_comm_group_sub {M₁ : Type u_1} {M₂ : Type u_2} [Add M₂] [HasZero M₂] [Neg M₂] [Sub M₂] [add_comm_group M₁] (f : M₁ → M₂) (hf : surjective f) (one : f 0 = 0) (mul : ∀ (x y : M₁), f (x + y) = f x + f y) (inv : ∀ (x : M₁), f (-x) = -f x) (div : ∀ (x y : M₁), f (x - y) = f x - f y) : add_comm_group M₂ :=
