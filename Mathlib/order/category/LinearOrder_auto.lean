...
def LinearOrder := category_theory.bundled linear_order

namespace LinearOrder


protected instance linear_order.to_partial_order.category_theory.bundled_hom.parent_projection :
...
def of (α : Type u_1) [linear_order α] : LinearOrder := category_theory.bundled.of α

protected instance inhabited : Inhabited LinearOrder := { default := of PUnit }

protected instance linear_order (α : LinearOrder) : linear_order ↥α := category_theory.bundled.str α
