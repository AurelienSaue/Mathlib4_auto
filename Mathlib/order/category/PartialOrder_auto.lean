...
protected instance partial_order.to_preorder.category_theory.bundled_hom.parent_projection : category_theory.bundled_hom.parent_projection partial_order.to_preorder :=
...
def of (α : Type u_1) [partial_order α] : PartialOrder :=
  category_theory.bundled.of α

protected instance inhabited : Inhabited PartialOrder :=
  { default := of PUnit }
