...
def Preorder := category_theory.bundled preorder

namespace Preorder


protected instance preorder_hom.category_theory.bundled_hom :
    category_theory.bundled_hom preorder_hom :=
...
def of (α : Type u_1) [preorder α] : Preorder := category_theory.bundled.of α

protected instance inhabited : Inhabited Preorder := { default := of PUnit }

protected instance preorder (α : Preorder) : preorder ↥α := category_theory.bundled.str α
