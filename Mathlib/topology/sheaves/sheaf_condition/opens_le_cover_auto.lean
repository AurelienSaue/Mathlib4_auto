...
protected instance opens_le_cover.inhabited {X : Top} {ι : Type v}
    (U : ι → topological_space.opens ↥X) [Inhabited ι] : Inhabited (opens_le_cover U) :=
  { default := { val := ⊥, property := sorry } }

protected instance opens_le_cover.category_theory.category {X : Top} {ι : Type v}
    (U : ι → topological_space.opens ↥X) : category_theory.category (opens_le_cover U) :=
...
-/
def hom_to_index {X : Top} {ι : Type v} {U : ι → topological_space.opens ↥X}
    (V : opens_le_cover U) : subtype.val V ⟶ U (index V) :=
...
-/
def opens_le_cover_cocone {X : Top} {ι : Type v} (U : ι → topological_space.opens ↥X) :
    category_theory.limits.cocone
        (category_theory.full_subcategory_inclusion
          fun (X_1 : topological_space.opens ↥X) => ∃ (i : ι), X_1 ≤ U i) :=
...
-/
def sheaf_condition_opens_le_cover {C : Type u} [category_theory.category C] {X : Top}
    (F : presheaf C X) :=
  {ι : Type v} →
    (U : ι → topological_space.opens ↥X) →
      category_theory.limits.is_limit
        (category_theory.functor.map_cone F
          (category_theory.limits.cocone.op (sheaf_condition.opens_le_cover_cocone U)))
...
-/
@[simp] def pairwise_to_opens_le_cover_obj {X : Top} {ι : Type v}
    (U : ι → topological_space.opens ↥X) : category_theory.pairwise ι → opens_le_cover U :=
  sorry
...
-/
def pairwise_to_opens_le_cover_map {X : Top} {ι : Type v} (U : ι → topological_space.opens ↥X)
    {V : category_theory.pairwise ι} {W : category_theory.pairwise ι} :
...
-/
def pairwise_to_opens_le_cover {X : Top} {ι : Type v} (U : ι → topological_space.opens ↥X) :
    category_theory.pairwise ι ⥤ opens_le_cover U :=
...
protected instance category_theory.comma.nonempty {X : Top} {ι : Type v}
    (U : ι → topological_space.opens ↥X) (V : opens_le_cover U) :
    Nonempty
        (category_theory.comma (category_theory.functor.from_punit V)
...
protected instance pairwise_to_opens_le_cover.category_theory.cofinal {X : Top} {ι : Type v}
    (U : ι → topological_space.opens ↥X) : category_theory.cofinal (pairwise_to_opens_le_cover U) :=
  sorry
...
-/
def pairwise_diagram_iso {X : Top} {ι : Type v} (U : ι → topological_space.opens ↥X) :
    category_theory.pairwise.diagram U ≅
        pairwise_to_opens_le_cover U ⋙
          category_theory.full_subcategory_inclusion
            fun (V : topological_space.opens ↥X) => ∃ (i : ι), V ≤ U i :=
...
-/
def pairwise_cocone_iso {X : Top} {ι : Type v} (U : ι → topological_space.opens ↥X) :
        ...
        category_theory.functor.obj
          (category_theory.equivalence.functor
            (category_theory.limits.cones.postcompose_equivalence
              (category_theory.nat_iso.op (pairwise_diagram_iso U))))
          (category_theory.limits.cone.whisker
            (category_theory.functor.op (pairwise_to_opens_le_cover U))
...
-/
def sheaf_condition_opens_le_cover_equiv_sheaf_condition_pairwise_intersections {C : Type u}
    [category_theory.category C] {X : Top} (F : presheaf C X) :
    sheaf_condition_opens_le_cover F ≃ sheaf_condition_pairwise_intersections F :=
  sorry
...
-/
def sheaf_condition_equiv_sheaf_condition_opens_le_cover {C : Type u} [category_theory.category C]
    {X : Top} [category_theory.limits.has_products C] (F : presheaf C X) :
    sheaf_condition F ≃ sheaf_condition_opens_le_cover F :=
