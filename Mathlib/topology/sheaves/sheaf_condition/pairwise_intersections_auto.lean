...
-/
def sheaf_condition_pairwise_intersections {X : Top} {C : Type u} [category_theory.category C]
    (F : presheaf C X) :=
  {ι : Type v} →
    (U : ι → topological_space.opens ↥X) →
      category_theory.limits.is_limit
        (category_theory.functor.map_cone F
          (category_theory.limits.cocone.op (category_theory.pairwise.cocone U)))
...
-/
def sheaf_condition_preserves_limit_pairwise_intersections {X : Top} {C : Type u}
    [category_theory.category C] (F : presheaf C X) :=
  {ι : Type v} →
    (U : ι → topological_space.opens ↥X) →
      category_theory.limits.preserves_limit
        (category_theory.functor.op (category_theory.pairwise.diagram U)) F
...
def cone_equiv_functor_obj {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X)
    (c :
...
/-- Implementation of `sheaf_condition_pairwise_intersections.cone_equiv`. -/
def cone_equiv_functor {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X) :
    category_theory.limits.cone
          (category_theory.functor.op (category_theory.pairwise.diagram U) ⋙ F) ⥤
  ...
  category_theory.functor.mk
    ...
    fun
      ...
      category_theory.limits.cone
        (category_theory.functor.op (category_theory.pairwise.diagram U) ⋙ F))
      (f : c ⟶ c') =>
      category_theory.limits.cone_morphism.mk (category_theory.limits.cone_morphism.hom f)

/-- Implementation of `sheaf_condition_pairwise_intersections.cone_equiv`. -/
@[simp] theorem cone_equiv_inverse_obj_π_app {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X)
    (c : category_theory.limits.cone (sheaf_condition_equalizer_products.diagram F U))
    (x : category_theory.pairwise ιᵒᵖ) :
    category_theory.nat_trans.app (category_theory.limits.cone.π (cone_equiv_inverse_obj F U c)) x =
              ...
              (fun (i : ι) =>
                category_theory.nat_trans.app (category_theory.limits.cone.π c)
                  ...
                  category_theory.limits.pi.π
                    (fun (i : ι) => category_theory.functor.obj F (opposite.op (U i))) i)
              fun (i j : ι) =>
                category_theory.nat_trans.app (category_theory.limits.cone.π c)
...
/-- Implementation of `sheaf_condition_pairwise_intersections.cone_equiv`. -/
@[simp] theorem cone_equiv_inverse_map_hom {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X)
    (c : category_theory.limits.cone (sheaf_condition_equalizer_products.diagram F U))
    (c' : category_theory.limits.cone (sheaf_condition_equalizer_products.diagram F U))
    ...
    category_theory.limits.cone_morphism.hom
          (category_theory.functor.map (cone_equiv_inverse F U) f) =
...
/-- Implementation of `sheaf_condition_pairwise_intersections.cone_equiv`. -/
def cone_equiv_unit_iso_app {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X)
    (c :
      category_theory.limits.cone
        (category_theory.functor.op (category_theory.pairwise.diagram U) ⋙ F)) :
    category_theory.functor.obj 𝟭 c ≅
        category_theory.functor.obj (cone_equiv_functor F U ⋙ cone_equiv_inverse F U) c :=
  category_theory.iso.mk (category_theory.limits.cone_morphism.mk 𝟙)
    (category_theory.limits.cone_morphism.mk 𝟙)

/-- Implementation of `sheaf_condition_pairwise_intersections.cone_equiv`. -/
@[simp] theorem cone_equiv_unit_iso_hom_app_hom {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X) :
    ∀
        (X_1 :
          category_theory.limits.cone
            (category_theory.functor.op (category_theory.pairwise.diagram U) ⋙ F)),
        category_theory.limits.cone_morphism.hom
            (category_theory.nat_trans.app (category_theory.iso.hom (cone_equiv_unit_iso F U))
              X_1) =
          𝟙 :=
  fun
    (X_1 :
...
/-- Implementation of `sheaf_condition_pairwise_intersections.cone_equiv`. -/
@[simp] theorem cone_equiv_counit_iso_hom_app_hom {X : Top} {C : Type u}
    [category_theory.category C] [category_theory.limits.has_products C] (F : presheaf C X)
    {ι : Type v} (U : ι → topological_space.opens ↥X) :
    ∀ (X_1 : category_theory.limits.cone (sheaf_condition_equalizer_products.diagram F U)),
        category_theory.limits.cone_morphism.hom
            (category_theory.nat_trans.app (category_theory.iso.hom (cone_equiv_counit_iso F U))
              X_1) =
          𝟙 :=
  fun (X_1 : category_theory.limits.cone (sheaf_condition_equalizer_products.diagram F U)) =>
    Eq.refl 𝟙

/--
Cones over `diagram U ⋙ F` are the same as a cones over the usual sheaf condition equalizer diagram.
-/
@[simp] theorem cone_equiv_functor_2 {X : Top} {C : Type u} [category_theory.category C]
    [category_theory.limits.has_products C] (F : presheaf C X) {ι : Type v}
    (U : ι → topological_space.opens ↥X) :
    category_theory.equivalence.functor (cone_equiv F U) = cone_equiv_functor F U :=
...
-/
def is_limit_map_cone_of_is_limit_sheaf_condition_fork {X : Top} {C : Type u}
    [category_theory.category C] [category_theory.limits.has_products C] (F : presheaf C X)
    {ι : Type v} (U : ι → topological_space.opens ↥X)
    (P : category_theory.limits.is_limit (sheaf_condition_equalizer_products.fork F U)) :
    category_theory.limits.is_limit
        (category_theory.functor.map_cone F
          (category_theory.limits.cocone.op (category_theory.pairwise.cocone U))) :=
    ...
    (coe_fn
      (equiv.symm
        (category_theory.limits.is_limit.of_cone_equiv
          (category_theory.equivalence.symm (cone_equiv F U))))
      P)
    (category_theory.iso.mk (category_theory.limits.cone_morphism.mk 𝟙)
      (category_theory.limits.cone_morphism.mk 𝟙))
...
-/
def is_limit_sheaf_condition_fork_of_is_limit_map_cone {X : Top} {C : Type u}
    [category_theory.category C] [category_theory.limits.has_products C] (F : presheaf C X)
    {ι : Type v} (U : ι → topological_space.opens ↥X)
    (Q :
      category_theory.limits.is_limit
...
-/
def sheaf_condition_equiv_sheaf_condition_pairwise_intersections {X : Top} {C : Type u}
    [category_theory.category C] [category_theory.limits.has_products C] (F : presheaf C X) :
    sheaf_condition F ≃ sheaf_condition_pairwise_intersections F :=
  equiv.Pi_congr_right
    fun (i : Type v) =>
      equiv.Pi_congr_right
        fun (U : i → topological_space.opens ↥X) =>
          equiv_of_subsingleton_of_subsingleton
            (sheaf_condition_pairwise_intersections.is_limit_map_cone_of_is_limit_sheaf_condition_fork
              F U)
            (sheaf_condition_pairwise_intersections.is_limit_sheaf_condition_fork_of_is_limit_map_cone
              F U)
...
-/
def sheaf_condition_equiv_sheaf_condition_preserves_limit_pairwise_intersections {X : Top}
    {C : Type u} [category_theory.category C] [category_theory.limits.has_products C]
    (F : presheaf C X) :
    sheaf_condition F ≃ sheaf_condition_preserves_limit_pairwise_intersections F :=
  sorry
