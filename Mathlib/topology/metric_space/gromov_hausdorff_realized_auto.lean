...
def candidates (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : set (prod_space_fun α β) :=
  set_of
    fun (f : prod_space_fun α β) =>
      (((((∀ (x y : α), f (sum.inl x, sum.inl y) = dist x y) ∧ ∀ (x y : β), f (sum.inr x, sum.inr y) = dist x y) ∧
              ∀ (x y : α ⊕ β), f (x, y) = f (y, x)) ∧
...
def candidates_b_of_candidates {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] (f : prod_space_fun α β) (fA : f ∈ candidates α β) : Cb α β :=
  bounded_continuous_function.mk_of_compact f sorry

theorem candidates_b_of_candidates_mem {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] (f : prod_space_fun α β) (fA : f ∈ candidates α β) : candidates_b_of_candidates f fA ∈ candidates_b α β :=
  fA

/-- The distance on α ⊕ β is a candidate -/
def candidates_b_dist (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Inhabited α] [metric_space β] [compact_space β] [Inhabited β] : Cb α β :=
  candidates_b_of_candidates (fun (p : (α ⊕ β) × (α ⊕ β)) => dist (prod.fst p) (prod.snd p)) sorry

theorem candidates_b_dist_mem_candidates_b {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : candidates_b_dist α β ∈ candidates_b α β :=
...
def HD {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] (f : Cb α β) : ℝ :=
...
theorem HD_below_aux1 {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] {f : Cb α β} (C : ℝ) {x : α} : bdd_below (set.range fun (y : β) => coe_fn f (sum.inl x, sum.inr y) + C) := sorry

theorem HD_below_aux2 {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] {f : Cb α β} (C : ℝ) {y : β} : bdd_below (set.range fun (x : α) => coe_fn f (sum.inl x, sum.inr y) + C) := sorry

/-- Explicit bound on HD (dist). This means that when looking for minimizers it will
be sufficient to look for functions with HD(f) bounded by this bound. -/
theorem HD_candidates_b_dist_le {α : Type u} {β : Type v} [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : HD (candidates_b_dist α β) ≤ metric.diam set.univ + 1 + metric.diam set.univ := sorry
...
def premetric_optimal_GH_dist (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : premetric_space (α ⊕ β) :=
...
def optimal_GH_injl (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] (x : α) : optimal_GH_coupling α β :=
  quotient.mk (sum.inl x)

/-- The injection of α in the optimal coupling between α and β is an isometry. -/
theorem isometry_optimal_GH_injl (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : isometry (optimal_GH_injl α β) :=
  iff.mpr isometry_emetric_iff_metric fun (x y : α) => id (candidates_dist_inl (optimal_GH_dist_mem_candidates_b α β) x y)

/-- Injection of β  in the optimal coupling between α and β -/
def optimal_GH_injr (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] (y : β) : optimal_GH_coupling α β :=
  quotient.mk (sum.inr y)

/-- The injection of β in the optimal coupling between α and β is an isometry. -/
theorem isometry_optimal_GH_injr (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : isometry (optimal_GH_injr α β) :=
  iff.mpr isometry_emetric_iff_metric fun (x y : β) => id (candidates_dist_inr (optimal_GH_dist_mem_candidates_b α β) x y)

/-- The optimal coupling between two compact spaces α and β is still a compact space -/
protected instance compact_space_optimal_GH_coupling (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] : compact_space (optimal_GH_coupling α β) := sorry
...
we need. -/
theorem Hausdorff_dist_optimal_le_HD (α : Type u) (β : Type v) [metric_space α] [compact_space α] [Nonempty α] [metric_space β] [compact_space β] [Nonempty β] {f : Cb α β} (h : f ∈ candidates_b α β) : metric.Hausdorff_dist (set.range (optimal_GH_injl α β)) (set.range (optimal_GH_injr α β)) ≤ HD f := sorry
