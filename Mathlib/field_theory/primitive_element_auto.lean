...
theorem exists_primitive_element_of_fintype_top (F : Type u_1) [field F] (E : Type u_2) [field E]
    [algebra F E] [fintype E] :
    ∃ (α : E), intermediate_field.adjoin F (intermediate_field.insert.insert ∅ α) = ⊤ :=
  sorry

/-- Primitive element theorem for finite dimensional extension of a finite field. -/
theorem exists_primitive_element_of_fintype_bot (F : Type u_1) [field F] (E : Type u_2) [field E]
    [algebra F E] [fintype F] [finite_dimensional F E] :
    ∃ (α : E), intermediate_field.adjoin F (intermediate_field.insert.insert ∅ α) = ⊤ :=
  exists_primitive_element_of_fintype_top F E

/-! ### Primitive element theorem for infinite fields -/

theorem primitive_element_inf_aux_exists_c {F : Type u_1} [field F] [infinite F] {E : Type u_2}
    [field E] (ϕ : F →+* E) (α : E) (β : E) (f : polynomial F) (g : polynomial F) :
    ∃ (c : F),
        ∀ (α' : E),
          α' ∈ polynomial.roots (polynomial.map ϕ f) →
            ∀ (β' : E),
              β' ∈ polynomial.roots (polynomial.map ϕ g) → -(α' - α) / (β' - β) ≠ coe_fn ϕ c :=
  sorry
...
theorem primitive_element_inf_aux {F : Type u_1} [field F] [infinite F] {E : Type u_2} [field E]
    (α : E) (β : E) [algebra F E] (F_sep : is_separable F E) :
    ∃ (γ : E),
        intermediate_field.adjoin F
            (intermediate_field.insert.insert (intermediate_field.insert.insert ∅ β) α) =
          intermediate_field.adjoin F (intermediate_field.insert.insert ∅ γ) :=
  sorry

/-- Primitive element theorem: a finite separable field extension `E` of `F` has a
  primitive element, i.e. there is an `α ∈ E` such that `F⟮α⟯ = (⊤ : subalgebra F E)`.-/
theorem exists_primitive_element {F : Type u_1} [field F] {E : Type u_2} [field E] [algebra F E]
