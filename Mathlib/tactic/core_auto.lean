...
-/
@[simp] theorem Mathlib.is_lawful_applicative.map_comp_pure {f : Type l_2 → Type l_1}
    [Applicative f] [c : is_lawful_applicative f] {α : Type l_2} {β : Type l_2} (g : α → β) :
    Functor.map g ∘ pure = pure ∘ g :=
