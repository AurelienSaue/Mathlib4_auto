...
theorem fun_mono_2 {α : Type} {β : Type} {γ : Type} {p : α → β → γ} {a1 : α} {a2 : α} {b1 : β}
    {b2 : β} : a1 = a2 → b1 = b2 → p a1 b1 = p a2 b2 :=
...
theorem pred_mono_2 {α : Type} {β : Type} {p : α → β → Prop} {a1 : α} {a2 : α} {b1 : β} {b2 : β} :
    a1 = a2 → b1 = b2 → (p a1 b1 ↔ p a2 b2) :=
  fun (h1 : a1 = a2) (h2 : b1 = b2) =>
    eq.mpr (id (Eq._oldrec (Eq.refl (p a1 b1 ↔ p a2 b2)) h1))
      (eq.mpr (id (Eq._oldrec (Eq.refl (p a2 b1 ↔ p a2 b2)) h2)) (iff.refl (p a2 b2)))

theorem pred_mono_2' {c : Prop → Prop → Prop} {a1 : Prop} {a2 : Prop} {b1 : Prop} {b2 : Prop} :
