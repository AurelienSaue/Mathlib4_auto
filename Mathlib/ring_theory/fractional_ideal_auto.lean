...
def is_fractional {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
  ...
  ∃ (a : R),
    ∃ (H : a ∈ S),
      ∀ (b : P), b ∈ I → localization_map.is_integer f (coe_fn (localization_map.to_map f) a * b)
...
@[simp] theorem val_eq_coe {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} (I : fractional_ideal f) : subtype.val I = ↑I :=
  rfl

@[simp] theorem coe_mk {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} (I : submodule R (localization_map.codomain f))
    (hI : is_fractional f I) : ↑{ val := I, property := hI } = I :=
  rfl
...
theorem ext_iff {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} {I : fractional_ideal f} {J : fractional_ideal f} :
    (∀ (x : P), x ∈ I ↔ x ∈ J) ↔ I = J :=
  { mp := fun (h : ∀ (x : P), x ∈ I ↔ x ∈ J) => ext (submodule.ext h),
    mpr := fun (h : I = J) (x : P) => h ▸ iff.rfl }
...
theorem fractional_of_subset_one {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    (h : I ≤ submodule.span R (singleton 1)) : is_fractional f I :=
  sorry

theorem is_fractional_of_le {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} {I : submodule R (localization_map.codomain f)}
    {J : fractional_ideal f} (hIJ : I ≤ ↑J) : is_fractional f I :=
  sorry
...
@[simp] theorem coe_coe_ideal {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    ↑↑I = localization_map.coe_submodule f I :=
  rfl
...
@[simp] theorem mem_coe_ideal {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    x ∈ ↑I ↔ ∃ (x' : R), ∃ (H : x' ∈ I), coe_fn (localization_map.to_map f) x' = x :=
  sorry
...
@[simp] theorem coe_to_fractional_ideal_bot {R : Type u_1} [comm_ring R] {S : submonoid R}
    {P : Type u_2} [comm_ring P] {f : localization_map S P} : ↑⊥ = 0 :=
  rfl

@[simp] theorem exists_mem_to_map_eq {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} {x : R} {I : ideal R} (h : S ≤ non_zero_divisors R) :
    (∃ (x' : R),
          x' ∈ I ∧ coe_fn (localization_map.to_map f) x' = coe_fn (localization_map.to_map f) x) ↔
        x ∈ I :=
  sorry

theorem coe_to_fractional_ideal_injective {R : Type u_1} [comm_ring R] {S : submonoid R}
    {P : Type u_2} [comm_ring P] {f : localization_map S P} (h : S ≤ non_zero_divisors R) :
...
theorem coe_to_fractional_ideal_eq_zero {R : Type u_1} [comm_ring R] {S : submonoid R}
    ...
    (hS : S ≤ non_zero_divisors R) : ↑I = 0 ↔ I = ⊥ :=
  sorry
...
theorem coe_to_submodule_eq_bot {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} {I : fractional_ideal f} : ↑I = ⊥ ↔ I = 0 :=
  sorry
...
theorem coe_one_eq_coe_submodule_one {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} : ↑1 = localization_map.coe_submodule f 1 :=
  rfl
...
protected instance partial_order {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
  ...
  partial_order.mk (fun (I J : fractional_ideal f) => subtype.val I ≤ subtype.val J)
    (preorder.lt._default fun (I J : fractional_ideal f) => subtype.val I ≤ subtype.val J) sorry
    sorry sorry
...
theorem zero_le {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} (I : fractional_ideal f) : 0 ≤ I :=
  sorry
...
@[simp] theorem bot_eq_zero {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} : ⊥ = 0 :=
  rfl

@[simp] theorem le_zero_iff {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} {I : fractional_ideal f} : I ≤ 0 ↔ I = 0 :=
  le_bot_iff

theorem eq_zero_iff {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} {I : fractional_ideal f} : I = 0 ↔ ∀ (x : P), x ∈ I → x = 0 :=
  sorry
...
protected instance lattice {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
  ...
  lattice.mk
    (fun (I J : fractional_ideal f) =>
      { val := subtype.val I ⊔ subtype.val J, property := fractional_sup I J })
    partial_order.le partial_order.lt sorry sorry sorry sorry sorry sorry
    (fun (I J : fractional_ideal f) =>
      { val := subtype.val I ⊓ subtype.val J, property := fractional_inf I J })
    sorry sorry sorry
...
theorem mul_mem_mul {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} {I : fractional_ideal f} {J : fractional_ideal f}
    {i : localization_map.codomain f} {j : localization_map.codomain f} (hi : i ∈ I) (hj : j ∈ J) :
    i * j ∈ I * J :=
  submodule.mul_mem_mul hi hj

theorem mul_le {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} {I : fractional_ideal f} {J : fractional_ideal f}
    {K : fractional_ideal f} : I * J ≤ K ↔ ∀ (i : P), i ∈ I → ∀ (j : P), j ∈ J → i * j ∈ K :=
  submodule.mul_le

protected theorem mul_induction_on {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} {I : fractional_ideal f} {J : fractional_ideal f}
    {C : localization_map.codomain f → Prop} {r : localization_map.codomain f} (hr : r ∈ I * J)
    (hm :
      ∀ (i : localization_map.codomain f),
        i ∈ I → ∀ (j : localization_map.codomain f), j ∈ J → C (i * j))
    (h0 : C 0) (ha : ∀ (x y : localization_map.codomain f), C x → C y → C (x + y))
    (hs : ∀ (r : R) (x : localization_map.codomain f), C x → C (r • x)) : C r :=
...
theorem add_le_add_left {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} {I : fractional_ideal f} {J : fractional_ideal f} (hIJ : I ≤ J)
    (J' : fractional_ideal f) : J' + I ≤ J' + J :=
...
@[simp] theorem coe_map {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} {P' : Type u_3} [comm_ring P'] {f' : localization_map S P'}
    (g : alg_hom R (localization_map.codomain f) (localization_map.codomain f'))
    (I : fractional_ideal f) : ↑(map g I) = submodule.map (alg_hom.to_linear_map g) ↑I :=
  rfl
...
@[simp] theorem mem_map {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    ...
    y ∈ map g I ↔ ∃ (x : localization_map.codomain f), x ∈ I ∧ coe_fn g x = y :=
  submodule.mem_map
...
@[simp] theorem map_map_symm {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    map (↑(alg_equiv.symm g)) (map (↑g) I) = I :=
  sorry
...
@[simp] theorem map_symm_map {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    {f' : localization_map S P'} (I : fractional_ideal f')
    (g : alg_equiv R (localization_map.codomain f) (localization_map.codomain f')) :
    map (↑g) (map (↑(alg_equiv.symm g)) I) = I :=
  sorry
...
@[simp] theorem map_equiv_apply {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    {f' : localization_map S P'}
    (g : alg_equiv R (localization_map.codomain f) (localization_map.codomain f'))
    (I : fractional_ideal f) : coe_fn (map_equiv g) I = map (↑g) I :=
  rfl
...
theorem is_fractional_span_iff {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    is_fractional f (submodule.span R s) ↔
        ∃ (a : R),
          ∃ (H : a ∈ S),
            ∀ (b : P),
              b ∈ s → localization_map.is_integer f (coe_fn (localization_map.to_map f) a * b) :=
  sorry
...
@[simp] theorem mem_canonical_equiv_apply {R : Type u_1} [comm_ring R] {S : submonoid R}
    ...
    x ∈ coe_fn (canonical_equiv f f') I ↔
        ∃ (y : P),
          ∃ (H : y ∈ I),
            coe_fn
                (localization_map.map f
                  (fun (_x : ↥S) =>
                    (fun (_a : ↥S) =>
                        subtype.cases_on _a
                          fun (val : R) (property : val ∈ S) => idRhs (val ∈ S) property)
                      _x)
                  f')
                y =
              x :=
...
theorem exists_ne_zero_mem_is_integer {R : Type u_1} [comm_ring R] {K : Type u_3} [field K]
    {g : fraction_map R K} {I : fractional_ideal g} [nontrivial R] (hI : I ≠ 0) :
    ∃ (x : R), ∃ (H : x ≠ 0), coe_fn (localization_map.to_map g) x ∈ I :=
  sorry
...
@[simp] theorem map_eq_zero_iff {R : Type u_1} [comm_ring R] {K : Type u_3} {K' : Type u_4}
  ...
  { mp := imp_of_not_imp_not (map h I = 0) (I = 0) (map_ne_zero h),
    mpr := fun (hI : I = 0) => Eq.symm hI ▸ map_zero h }
...
protected instance nontrivial {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} : nontrivial (fractional_ideal g) :=
  nontrivial.mk
    (Exists.intro 0
      (Exists.intro 1
        fun (h : 0 = 1) =>
          (fun (this : 1 ∈ 0) => one_ne_zero (iff.mp mem_zero_iff this))
            (eq.mpr
              (id
                (Eq._oldrec (Eq.refl (1 ∈ 0))
                  (Eq.symm (ring_hom.map_one (localization_map.to_map g)))))
              (eq.mpr
                ((fun (ᾰ ᾰ_1 : K) (e_2 : ᾰ = ᾰ_1) (ᾰ_2 ᾰ_3 : fractional_ideal g)
                    (e_3 : ᾰ_2 = ᾰ_3) => congr (congr_arg has_mem.mem e_2) e_3)
                  (coe_fn (localization_map.to_map g) 1) (coe_fn (localization_map.to_map g) 1)
                  (Eq.refl (coe_fn (localization_map.to_map g) 1)) 0 1 h)
                (coe_mem_one 1)))))

theorem fractional_div_of_nonzero {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} {J : fractional_ideal g} (h : J ≠ 0) :
    is_fractional g (subtype.val I / subtype.val J) :=
  sorry

protected instance fractional_ideal_has_div {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4}
    [field K] {g : fraction_map R₁ K} : Div (fractional_ideal g) :=
  { div :=
...
@[simp] theorem div_zero {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} : I / 0 = 0 :=
  dif_pos rfl

theorem div_nonzero {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} {J : fractional_ideal g} (h : J ≠ 0) :
    I / J = { val := subtype.val I / subtype.val J, property := fractional_div_of_nonzero h } :=
  dif_neg h

@[simp] theorem coe_div {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} {J : fractional_ideal g} (hJ : J ≠ 0) :
    ↑(I / J) = ↑I / ↑J :=
  sorry

theorem mem_div_iff_of_nonzero {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} {J : fractional_ideal g} (h : J ≠ 0) {x : K} :
    x ∈ I / J ↔ ∀ (y : K), y ∈ J → x * y ∈ I :=
  eq.mpr (id (Eq._oldrec (Eq.refl (x ∈ I / J ↔ ∀ (y : K), y ∈ J → x * y ∈ I)) (div_nonzero h)))
    submodule.mem_div_iff_forall_mul_mem

theorem mul_one_div_le_one {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} : I * (1 / I) ≤ 1 :=
  sorry

theorem le_self_mul_one_div {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} (hI : I ≤ 1) : I ≤ I * (1 / I) :=
  sorry

theorem le_div_iff_of_nonzero {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} {J : fractional_ideal g}
    {J' : fractional_ideal g} (hJ' : J' ≠ 0) :
    I ≤ J / J' ↔ ∀ (x : K), x ∈ I → ∀ (y : K), y ∈ J' → x * y ∈ J :=
  sorry

theorem le_div_iff_mul_le {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} {J : fractional_ideal g}
    {J' : fractional_ideal g} (hJ' : J' ≠ 0) : I ≤ J / J' ↔ I * J' ≤ J :=
  sorry

@[simp] theorem div_one {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} : I / 1 = I :=
  sorry

theorem ne_zero_of_mul_eq_one {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} (I : fractional_ideal g) (J : fractional_ideal g) (h : I * J = 1) :
    I ≠ 0 :=
  sorry

theorem eq_one_div_of_mul_eq_one {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} (I : fractional_ideal g) (J : fractional_ideal g) (h : I * J = 1) :
    J = 1 / I :=
  congr_arg units.inv (units.ext rfl)

theorem mul_div_self_cancel_iff {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} :
    I * (1 / I) = 1 ↔ ∃ (J : fractional_ideal g), I * J = 1 :=
  sorry

@[simp] theorem map_div {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {K' : Type u_5} [field K'] {g' : fraction_map R₁ K'}
    (I : fractional_ideal g) (J : fractional_ideal g)
    (h : alg_equiv R₁ (localization_map.codomain g) (localization_map.codomain g')) :
    map (↑h) (I / J) = map (↑h) I / map (↑h) J :=
  sorry

@[simp] theorem map_one_div {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {K' : Type u_5} [field K'] {g' : fraction_map R₁ K'}
...
@[simp] theorem coe_span_singleton {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} (x : localization_map.codomain f) :
    ↑(span_singleton x) = submodule.span R (singleton x) :=
  rfl

@[simp] theorem mem_span_singleton {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} {x : localization_map.codomain f}
    {y : localization_map.codomain f} : x ∈ span_singleton y ↔ ∃ (z : R), z • y = x :=
...
theorem eq_span_singleton_of_principal {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    [comm_ring P] {f : localization_map S P} (I : fractional_ideal f) [submodule.is_principal ↑I] :
    I = span_singleton (submodule.is_principal.generator ↑I) :=
...
theorem is_principal_iff {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2} [comm_ring P]
    {f : localization_map S P} (I : fractional_ideal f) :
    submodule.is_principal ↑I ↔ ∃ (x : localization_map.codomain f), I = span_singleton x :=
  sorry
...
@[simp] theorem coe_ideal_span_singleton {R : Type u_1} [comm_ring R] {S : submonoid R}
    ...
    ↑(submodule.span R (singleton x)) = span_singleton (coe_fn (localization_map.to_map f) x) :=
  sorry
...
theorem mem_singleton_mul {R : Type u_1} [comm_ring R] {S : submonoid R} {P : Type u_2}
    ...
    y ∈ span_singleton x * I ↔ ∃ (y' : localization_map.codomain f), ∃ (H : y' ∈ I), y = x * y' :=
  sorry

theorem one_div_span_singleton {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} (x : localization_map.codomain g) :
    1 / span_singleton x = span_singleton (x⁻¹) :=
  sorry

@[simp] theorem div_span_singleton {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} (J : fractional_ideal g) (d : localization_map.codomain g) :
    J / span_singleton d = span_singleton (d⁻¹) * J :=
  sorry

theorem exists_eq_span_singleton_mul {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} (I : fractional_ideal g) :
    ∃ (a : R₁),
        ∃ (aI : ideal R₁),
          a ≠ 0 ∧ I = span_singleton (coe_fn (localization_map.to_map g) a⁻¹) * ↑aI :=
  sorry
...
theorem is_noetherian_zero {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} : is_noetherian R₁ ↥0 :=
  sorry

theorem is_noetherian_iff {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} {I : fractional_ideal g} :
    is_noetherian R₁ ↥I ↔ ∀ (J : fractional_ideal g), J ≤ I → submodule.fg ↑J :=
  sorry

theorem is_noetherian_coe_to_fractional_ideal {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4}
    [field K] {g : fraction_map R₁ K} [is_noetherian_ring R₁] (I : ideal R₁) :
    is_noetherian R₁ ↥↑I :=
  sorry

theorem is_noetherian_span_singleton_inv_to_map_mul {R₁ : Type u_3} [integral_domain R₁]
    {K : Type u_4} [field K] {g : fraction_map R₁ K} (x : R₁) {I : fractional_ideal g}
    (hI : is_noetherian R₁ ↥I) :
    is_noetherian R₁ ↥(span_singleton (coe_fn (localization_map.to_map g) x⁻¹) * I) :=
  sorry

/-- Every fractional ideal of a noetherian integral domain is noetherian. -/
theorem is_noetherian {R₁ : Type u_3} [integral_domain R₁] {K : Type u_4} [field K]
    {g : fraction_map R₁ K} [is_noetherian_ring R₁] (I : fractional_ideal g) :
    is_noetherian R₁ ↥I :=
  sorry
