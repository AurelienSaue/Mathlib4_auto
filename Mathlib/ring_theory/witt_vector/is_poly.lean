...
theorem poly_eq_of_witt_polynomial_bind_eq' (p : ℕ) {idx : Type u_2} [hp : fact (nat.prime p)] (f : ℕ → mv_polynomial (idx × ℕ) ℤ) (g : ℕ → mv_polynomial (idx × ℕ) ℤ) (h : ∀ (n : ℕ),
  coe_fn (mv_polynomial.bind₁ f) (witt_polynomial p ℤ n) = coe_fn (mv_polynomial.bind₁ g) (witt_polynomial p ℤ n)) : f = g := sorry

theorem poly_eq_of_witt_polynomial_bind_eq (p : ℕ) [hp : fact (nat.prime p)] (f : ℕ → mv_polynomial ℕ ℤ) (g : ℕ → mv_polynomial ℕ ℤ) (h : ∀ (n : ℕ),
  coe_fn (mv_polynomial.bind₁ f) (witt_polynomial p ℤ n) = coe_fn (mv_polynomial.bind₁ g) (witt_polynomial p ℤ n)) : f = g := sorry
...
protected instance id_is_poly (p : ℕ) : is_poly p fun (_x : Type u_1) (_x_1 : comm_ring _x) => id :=
  Exists.intro mv_polynomial.X
    fun (R : Type u_1) (_inst_4 : comm_ring R) (x : witt_vector p R) =>
      eq.mpr
        (id
          ((fun (a a_1 : ℕ → R) (e_1 : a = a_1) (ᾰ ᾰ_1 : ℕ → R) (e_2 : ᾰ = ᾰ_1) => congr (congr_arg Eq e_1) e_2)
            (coeff ((fun (_x : Type u_1) (_x_1 : comm_ring _x) => id) R _inst_4 x)) (coeff x)
            ((fun (x x_1 : witt_vector p R) (e_1 : x = x_1) => congr_arg coeff e_1)
              ((fun (_x : Type u_1) (_x_1 : comm_ring _x) => id) R _inst_4 x) x (id.equations._eqn_1 x))
            (fun (n : ℕ) => coe_fn (mv_polynomial.aeval (coeff x)) (mv_polynomial.X n)) (coeff x)
            (funext fun (n : ℕ) => mv_polynomial.aeval_X (coeff x) n)))
        (Eq.refl (coeff x))

protected instance id_is_poly_i' (p : ℕ) : is_poly p fun (_x : Type u_1) (_x_1 : comm_ring _x) (a : witt_vector p _x) => a :=
  witt_vector.id_is_poly p

namespace is_poly


protected instance inhabited (p : ℕ) : Inhabited (is_poly p fun (_x : Type u_1) (_x_1 : comm_ring _x) => id) :=
  { default := witt_vector.id_is_poly p }

theorem ext {p : ℕ} [hp : fact (nat.prime p)] {f : {R : Type u} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} {g : {R : Type u} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} (hf : is_poly p f) (hg : is_poly p g) (h : ∀ (R : Type u) [_Rcr : comm_ring R] (x : witt_vector p R) (n : ℕ),
  coe_fn (ghost_component n) (f x) = coe_fn (ghost_component n) (g x)) (R : Type u) [comm_ring R] (x : witt_vector p R) : f x = g x := sorry

/-- The composition of polynomial functions is polynomial. -/
theorem comp {p : ℕ} {g : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} {f : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} (hg : is_poly p g) (hf : is_poly p f) : is_poly p fun (R : Type u_1) (_Rcr : comm_ring R) => g ∘ f := sorry
...
/-- The composition of polynomial functions is polynomial. -/
theorem is_poly₂.comp {p : ℕ} {h : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} {f : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} {g : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} (hh : is_poly₂ p h) (hf : is_poly p f) (hg : is_poly p g) : is_poly₂ p fun (R : Type u_1) (_Rcr : comm_ring R) (x y : witt_vector p R) => h (f x) (g y) := sorry

/-- The composition of a polynomial function with a binary polynomial function is polynomial. -/
theorem is_poly.comp₂ {p : ℕ} {g : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} {f : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} (hg : is_poly p g) (hf : is_poly₂ p f) : is_poly₂ p fun (R : Type u_1) (_Rcr : comm_ring R) (x y : witt_vector p R) => g (f x y) := sorry

/-- The diagonal `λ x, f x x` of a polynomial function `f` is polynomial. -/
theorem is_poly₂.diag {p : ℕ} {f : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} (hf : is_poly₂ p f) : is_poly p fun (R : Type u_1) (_Rcr : comm_ring R) (x : witt_vector p R) => f x x := sorry
...
theorem neg_is_poly {p : ℕ} [hp : fact (nat.prime p)] : is_poly p fun (R : Type u_1) (_x : comm_ring R) => Neg.neg := sorry
...
protected instance zero_is_poly {p : ℕ} [hp : fact (nat.prime p)] : is_poly p fun (_x : Type u_1) (_x_1 : comm_ring _x) (_x_2 : witt_vector p _x) => 0 :=
  Exists.intro 0
    fun (R : Type u_1) (_inst_4 : comm_ring R) (x : witt_vector p R) =>
      funext
        fun (n : ℕ) =>
          eq.mpr
            (id
              ((fun (a a_1 : R) (e_1 : a = a_1) (ᾰ ᾰ_1 : R) (e_2 : ᾰ = ᾰ_1) => congr (congr_arg Eq e_1) e_2)
                (coeff ((fun (_x : Type u_1) (_x_1 : comm_ring _x) (_x_2 : witt_vector p _x) => 0) R _inst_4 x) n) 0
                (zero_coeff p R n) (coe_fn (mv_polynomial.aeval (coeff x)) (HasZero.zero n)) 0
                (Eq.trans
                  ((fun (x x_1 : alg_hom ℤ (mv_polynomial ℕ ℤ) R) (e_1 : x = x_1) (ᾰ ᾰ_1 : mv_polynomial ℕ ℤ)
...
@[simp] theorem bind₁_zero_witt_polynomial {p : ℕ} {R : Type u} [hp : fact (nat.prime p)] [comm_ring R] (n : ℕ) : coe_fn (mv_polynomial.bind₁ 0) (witt_polynomial p R n) = 0 := sorry

/-- The coefficients of `1 : 𝕎 R` as polynomials. -/
def one_poly (n : ℕ) : mv_polynomial ℕ ℤ :=
  ite (n = 0) 1 0

@[simp] theorem bind₁_one_poly_witt_polynomial {p : ℕ} [hp : fact (nat.prime p)] (n : ℕ) : coe_fn (mv_polynomial.bind₁ one_poly) (witt_polynomial p ℤ n) = 1 := sorry

/-- The function that is constantly one on Witt vectors is a polynomial function. -/
protected instance one_is_poly {p : ℕ} [hp : fact (nat.prime p)] : is_poly p fun (_x : Type u_1) (_x_1 : comm_ring _x) (_x_2 : witt_vector p _x) => 1 := sorry

/-- Addition of Witt vectors is a polynomial function. -/
theorem add_is_poly₂ {p : ℕ} [fact (nat.prime p)] : is_poly₂ p fun (_x : Type u_1) (_x_1 : comm_ring _x) => Add.add :=
...
theorem mul_is_poly₂ {p : ℕ} [fact (nat.prime p)] : is_poly₂ p fun (_x : Type u_1) (_x_1 : comm_ring _x) => Mul.mul :=
...
theorem is_poly.map {p : ℕ} {R : Type u} {S : Type u} [hp : fact (nat.prime p)] [comm_ring R] [comm_ring S] {f : {R : Type u} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} (hf : is_poly p f) (g : R →+* S) (x : witt_vector p R) : coe_fn (map g) (f x) = f (coe_fn (map g) x) := sorry

namespace is_poly₂


protected instance inhabited {p : ℕ} [fact (nat.prime p)] : Inhabited (is_poly₂ p fun (_x : Type u_1) (_x_1 : comm_ring _x) => Add.add) :=
  { default := add_is_poly₂ }

/-- The composition of a binary polynomial function
 with a unary polynomial function in the first argument is polynomial. -/
theorem comp_left {p : ℕ} {g : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} {f : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} (hg : is_poly₂ p g) (hf : is_poly p f) : is_poly₂ p fun (R : Type u_1) (_Rcr : comm_ring R) (x y : witt_vector p R) => g (f x) y :=
  comp hg hf (witt_vector.id_is_poly p)

/-- The composition of a binary polynomial function
 with a unary polynomial function in the second argument is polynomial. -/
theorem comp_right {p : ℕ} {g : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} {f : {R : Type u_1} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R} (hg : is_poly₂ p g) (hf : is_poly p f) : is_poly₂ p fun (R : Type u_1) (_Rcr : comm_ring R) (x y : witt_vector p R) => g x (f y) :=
  comp hg (witt_vector.id_is_poly p) hf

theorem ext {p : ℕ} [hp : fact (nat.prime p)] {f : {R : Type u} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} {g : {R : Type u} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} (hf : is_poly₂ p f) (hg : is_poly₂ p g) (h : ∀ (R : Type u) [_Rcr : comm_ring R] (x y : witt_vector p R) (n : ℕ),
  coe_fn (ghost_component n) (f x y) = coe_fn (ghost_component n) (g x y)) (R : Type u) [comm_ring R] (x : witt_vector p R) (y : witt_vector p R) : f x y = g x y := sorry

-- unfortunately this is not universe polymorphic, merely because `f` isn't

theorem map {p : ℕ} {R : Type u} {S : Type u} [hp : fact (nat.prime p)] [comm_ring R] [comm_ring S] {f : {R : Type u} → [_inst_3 : comm_ring R] → witt_vector p R → witt_vector p R → witt_vector p R} (hf : is_poly₂ p f) (g : R →+* S) (x : witt_vector p R) (y : witt_vector p R) : coe_fn (map g) (f x y) = f (coe_fn (map g) x) (coe_fn (map g) y) := sorry
