...
@[simp] theorem cast_coe_nat {α : Type u_1} [division_ring α] (n : ℕ) : ↑↑n = ↑n := cast_coe_int ↑n
...
theorem cast_mk_of_ne_zero {α : Type u_1} [division_ring α] (a : ℤ) (b : ℤ) (b0 : ↑b ≠ 0) :
    ↑(mk a b) = ↑a / ↑b :=
  sorry

theorem cast_add_of_ne_zero {α : Type u_1} [division_ring α] {m : ℚ} {n : ℚ} :
    ↑(denom m) ≠ 0 → ↑(denom n) ≠ 0 → ↑(m + n) = ↑m + ↑n :=
  sorry

@[simp] theorem cast_neg {α : Type u_1} [division_ring α] (n : ℚ) : ↑(-n) = -↑n := sorry

theorem cast_sub_of_ne_zero {α : Type u_1} [division_ring α] {m : ℚ} {n : ℚ} (m0 : ↑(denom m) ≠ 0)
    (n0 : ↑(denom n) ≠ 0) : ↑(m - n) = ↑m - ↑n :=
  sorry

theorem cast_mul_of_ne_zero {α : Type u_1} [division_ring α] {m : ℚ} {n : ℚ} :
    ↑(denom m) ≠ 0 → ↑(denom n) ≠ 0 → ↑(m * n) = ↑m * ↑n :=
  sorry

theorem cast_inv_of_ne_zero {α : Type u_1} [division_ring α] {n : ℚ} :
    ↑(num n) ≠ 0 → ↑(denom n) ≠ 0 → ↑(n⁻¹) = (↑n⁻¹) :=
  sorry

theorem cast_div_of_ne_zero {α : Type u_1} [division_ring α] {m : ℚ} {n : ℚ} (md : ↑(denom m) ≠ 0)
    (nn : ↑(num n) ≠ 0) (nd : ↑(denom n) ≠ 0) : ↑(m / n) = ↑m / ↑n :=
  sorry

@[simp] theorem cast_inj {α : Type u_1} [division_ring α] [char_zero α] {m : ℚ} {n : ℚ} :
    ↑m = ↑n ↔ m = n :=
  sorry
...
@[simp] theorem cast_eq_zero {α : Type u_1} [division_ring α] [char_zero α] {n : ℚ} :
    ↑n = 0 ↔ n = 0 :=
...
@[simp] theorem cast_add {α : Type u_1} [division_ring α] [char_zero α] (m : ℚ) (n : ℚ) :
    ↑(m + n) = ↑m + ↑n :=
  cast_add_of_ne_zero (iff.mpr nat.cast_ne_zero (ne_of_gt (pos m)))
    (iff.mpr nat.cast_ne_zero (ne_of_gt (pos n)))

@[simp] theorem cast_sub {α : Type u_1} [division_ring α] [char_zero α] (m : ℚ) (n : ℚ) :
    ↑(m - n) = ↑m - ↑n :=
  cast_sub_of_ne_zero (iff.mpr nat.cast_ne_zero (ne_of_gt (pos m)))
    (iff.mpr nat.cast_ne_zero (ne_of_gt (pos n)))

@[simp] theorem cast_mul {α : Type u_1} [division_ring α] [char_zero α] (m : ℚ) (n : ℚ) :
    ↑(m * n) = ↑m * ↑n :=
  cast_mul_of_ne_zero (iff.mpr nat.cast_ne_zero (ne_of_gt (pos m)))
    (iff.mpr nat.cast_ne_zero (ne_of_gt (pos n)))

@[simp] theorem cast_bit0 {α : Type u_1} [division_ring α] [char_zero α] (n : ℚ) :
    ↑(bit0 n) = bit0 ↑n :=
  cast_add n n

@[simp] theorem cast_bit1 {α : Type u_1} [division_ring α] [char_zero α] (n : ℚ) :
    ↑(bit1 n) = bit1 ↑n :=
  sorry
...
@[simp] theorem cast_div {α : Type u_1} [division_ring α] [char_zero α] (m : ℚ) (n : ℚ) :
    ↑(m / n) = ↑m / ↑n :=
  ring_hom.map_div (cast_hom α) m n

theorem cast_mk {α : Type u_1} [division_ring α] [char_zero α] (a : ℤ) (b : ℤ) :
    ↑(mk a b) = ↑a / ↑b :=
  sorry

@[simp] theorem cast_pow {α : Type u_1} [division_ring α] [char_zero α] (q : ℚ) (k : ℕ) :
    ↑(q ^ k) = ↑q ^ k :=
  ring_hom.map_pow (cast_hom α) q k

@[simp] theorem cast_nonneg {α : Type u_1} [linear_ordered_field α] {n : ℚ} : 0 ≤ ↑n ↔ 0 ≤ n :=
  sorry

@[simp] theorem cast_le {α : Type u_1} [linear_ordered_field α] {m : ℚ} {n : ℚ} : ↑m ≤ ↑n ↔ m ≤ n :=
  sorry

@[simp] theorem cast_lt {α : Type u_1} [linear_ordered_field α] {m : ℚ} {n : ℚ} : ↑m < ↑n ↔ m < n :=
  sorry
...
@[simp] theorem cast_min {α : Type u_1} [linear_ordered_field α] {a : ℚ} {b : ℚ} :
    ↑(min a b) = min ↑a ↑b :=
  sorry

@[simp] theorem cast_max {α : Type u_1} [linear_ordered_field α] {a : ℚ} {b : ℚ} :
    ↑(max a b) = max ↑a ↑b :=
  sorry

@[simp] theorem cast_abs {α : Type u_1} [linear_ordered_field α] {q : ℚ} : ↑(abs q) = abs ↑q :=
  sorry
...
theorem ring_hom.map_rat_cast {k : Type u_1} {k' : Type u_2} [division_ring k] [char_zero k]
    [division_ring k'] (f : k →+* k') (r : ℚ) : coe_fn f ↑r = ↑r :=
