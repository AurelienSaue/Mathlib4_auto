...
protected instance mv_polynomial.invertible_C (σ : Type u_1) {R : Type u_2} [comm_semiring R] (r : R) [invertible r] : invertible (coe_fn mv_polynomial.C r) :=
...
protected instance mv_polynomial.invertible_coe_nat (σ : Type u_1) (R : Type u_2) (p : ℕ) [comm_semiring R] [invertible ↑p] : invertible ↑p :=
