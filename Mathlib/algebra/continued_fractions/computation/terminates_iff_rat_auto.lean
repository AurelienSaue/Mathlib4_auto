...
theorem exists_gcf_pair_rat_eq_of_nth_conts_aux {K : Type u_1} [linear_ordered_field K]
    [floor_ring K] (v : K) (n : ℕ) :
    ∃ (conts : pair ℚ),
        continuants_aux (generalized_continued_fraction.of v) n = pair.map coe conts :=
  sorry

theorem exists_gcf_pair_rat_eq_nth_conts {K : Type u_1} [linear_ordered_field K] [floor_ring K]
    (v : K) (n : ℕ) :
    ∃ (conts : pair ℚ), continuants (generalized_continued_fraction.of v) n = pair.map coe conts :=
  sorry

theorem exists_rat_eq_nth_numerator {K : Type u_1} [linear_ordered_field K] [floor_ring K] (v : K)
    (n : ℕ) : ∃ (q : ℚ), numerators (generalized_continued_fraction.of v) n = ↑q :=
  sorry

theorem exists_rat_eq_nth_denominator {K : Type u_1} [linear_ordered_field K] [floor_ring K] (v : K)
    (n : ℕ) : ∃ (q : ℚ), denominators (generalized_continued_fraction.of v) n = ↑q :=
  sorry

/-- Every finite convergent corresponds to a rational number. -/
theorem exists_rat_eq_nth_convergent {K : Type u_1} [linear_ordered_field K] [floor_ring K] (v : K)
    (n : ℕ) : ∃ (q : ℚ), convergents (generalized_continued_fraction.of v) n = ↑q :=
  sorry

/-- Every terminating continued fraction corresponds to a rational number. -/
theorem exists_rat_eq_of_terminates {K : Type u_1} [linear_ordered_field K] [floor_ring K] {v : K}
    (terminates : terminates (generalized_continued_fraction.of v)) : ∃ (q : ℚ), v = ↑q :=
  sorry
...
theorem coe_of_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K] {v : K}
    {q : ℚ} (v_eq_q : v = ↑q) : mapFr coe (int_fract_pair.of q) = int_fract_pair.of v :=
  sorry

theorem coe_stream_nth_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K]
    {v : K} {q : ℚ} (v_eq_q : v = ↑q) (n : ℕ) :
    option.map (mapFr coe) (int_fract_pair.stream q n) = int_fract_pair.stream v n :=
  sorry

theorem coe_stream_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K]
    {v : K} {q : ℚ} (v_eq_q : v = ↑q) :
    stream.map (option.map (mapFr coe)) (int_fract_pair.stream q) = int_fract_pair.stream v :=
...
theorem coe_of_h_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K]
    {v : K} {q : ℚ} (v_eq_q : v = ↑q) :
    ↑(h (generalized_continued_fraction.of q)) = h (generalized_continued_fraction.of v) :=
  sorry

theorem coe_of_s_nth_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K]
    {v : K} {q : ℚ} (v_eq_q : v = ↑q) (n : ℕ) :
    option.map (pair.map coe) (seq.nth (s (generalized_continued_fraction.of q)) n) =
        seq.nth (s (generalized_continued_fraction.of v)) n :=
  sorry

theorem coe_of_s_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K]
    {v : K} {q : ℚ} (v_eq_q : v = ↑q) :
    seq.map (pair.map coe) (s (generalized_continued_fraction.of q)) =
        s (generalized_continued_fraction.of v) :=
  sorry

/-- Given `(v : K), (q : ℚ), and v = q`, we have that `gcf.of q = gcf.of v` -/
theorem coe_of_rat_eq {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K] {v : K}
    {q : ℚ} (v_eq_q : v = ↑q) :
    mk (↑(h (generalized_continued_fraction.of q)))
          (seq.map (pair.map coe) (s (generalized_continued_fraction.of q))) =
        generalized_continued_fraction.of v :=
  sorry

theorem of_terminates_iff_of_rat_terminates {K : Type u_1} [linear_ordered_field K] [floor_ring K]
    [archimedean K] {v : K} {q : ℚ} (v_eq_q : v = ↑q) :
    terminates (generalized_continued_fraction.of v) ↔
        terminates (generalized_continued_fraction.of q) :=
  sorry
...
-/
theorem of_inv_fr_num_lt_num_of_pos {q : ℚ} (q_pos : 0 < q) :
    rat.num (fr (int_fract_pair.of (q⁻¹))) < rat.num q :=
...
theorem stream_succ_nth_fr_num_lt_nth_fr_num_rat {q : ℚ} {n : ℕ} {ifp_n : int_fract_pair ℚ}
    {ifp_succ_n : int_fract_pair ℚ} (stream_nth_eq : int_fract_pair.stream q n = some ifp_n)
    (stream_succ_nth_eq : int_fract_pair.stream q (n + 1) = some ifp_succ_n) :
    rat.num (fr ifp_succ_n) < rat.num (fr ifp_n) :=
  sorry

theorem stream_nth_fr_num_le_fr_num_sub_n_rat {q : ℚ} {n : ℕ} {ifp_n : int_fract_pair ℚ} :
    int_fract_pair.stream q n = some ifp_n →
        rat.num (fr ifp_n) ≤ rat.num (fr (int_fract_pair.of q)) - ↑n :=
  sorry
...
theorem terminates_iff_rat {K : Type u_1} [linear_ordered_field K] [floor_ring K] [archimedean K]
    (v : K) : terminates (generalized_continued_fraction.of v) ↔ ∃ (q : ℚ), v = ↑q :=
  sorry
