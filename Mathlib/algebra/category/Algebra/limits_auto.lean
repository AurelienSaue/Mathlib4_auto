...
protected instance semiring_obj {R : Type u} [comm_ring R] {J : Type v}
    [category_theory.small_category J] (F : J ⥤ Algebra R) (j : J) :
    semiring (category_theory.functor.obj (F ⋙ category_theory.forget (Algebra R)) j) :=
  id ring.to_semiring

protected instance algebra_obj {R : Type u} [comm_ring R] {J : Type v}
    [category_theory.small_category J] (F : J ⥤ Algebra R) (j : J) :
    algebra R (category_theory.functor.obj (F ⋙ category_theory.forget (Algebra R)) j) :=
...
-/
def sections_subalgebra {R : Type u} [comm_ring R] {J : Type v} [category_theory.small_category J]
    (F : J ⥤ Algebra R) : subalgebra R ((j : J) → ↥(category_theory.functor.obj F j)) :=
  subalgebra.mk
    (subsemiring.carrier
...
protected instance limit_semiring {R : Type u} [comm_ring R] {J : Type v}
    [category_theory.small_category J] (F : J ⥤ Algebra R) :
    ring
        (category_theory.limits.cone.X
          (category_theory.limits.types.limit_cone (F ⋙ category_theory.forget (Algebra R)))) :=
  id (subalgebra.ring R ((j : J) → ↥(category_theory.functor.obj F j)) (sections_subalgebra F))

protected instance limit_algebra {R : Type u} [comm_ring R] {J : Type v}
    [category_theory.small_category J] (F : J ⥤ Algebra R) :
    algebra R
        (category_theory.limits.cone.X
          (category_theory.limits.types.limit_cone (F ⋙ category_theory.forget (Algebra R)))) :=
...
def limit_π_alg_hom {R : Type u} [comm_ring R] {J : Type v} [category_theory.small_category J]
    (F : J ⥤ Algebra R) (j : J) :
    alg_hom R
        (category_theory.limits.cone.X
          (category_theory.limits.types.limit_cone (F ⋙ category_theory.forget (Algebra R))))
  ...
  alg_hom.mk
    (ring_hom.to_fun
      (SemiRing.limit_π_ring_hom
        (F ⋙ category_theory.forget₂ (Algebra R) Ring ⋙ category_theory.forget₂ Ring SemiRing) j))
    sorry sorry sorry sorry sorry
...
-/
def limit_cone {R : Type u} [comm_ring R] {J : Type v} [category_theory.small_category J]
    (F : J ⥤ Algebra R) : category_theory.limits.cone F :=
...
(Internal use only; use the limits API.)
-/
def limit_cone_is_limit {R : Type u} [comm_ring R] {J : Type v} [category_theory.small_category J]
    (F : J ⥤ Algebra R) : category_theory.limits.is_limit (limit_cone F) :=
...
/-- The category of R-algebras has all limits. -/
protected instance has_limits {R : Type u} [comm_ring R] :
...
-/
def forget₂_Ring_preserves_limits_aux {R : Type u} [comm_ring R] {J : Type v}
    [category_theory.small_category J] (F : J ⥤ Algebra R) :
    category_theory.limits.is_limit
        (category_theory.functor.map_cone (category_theory.forget₂ (Algebra R) Ring)
...
-/
protected instance forget₂_Ring_preserves_limits {R : Type u} [comm_ring R] :
      ...
      category_theory.limits.preserves_limits_of_shape.mk
        fun (F : J ⥤ Algebra R) =>
          category_theory.limits.preserves_limit_of_preserves_limit_cone
            (has_limits.limit_cone_is_limit F) (forget₂_Ring_preserves_limits_aux F)

/--
An auxiliary declaration to speed up typechecking.
-/
def forget₂_Module_preserves_limits_aux {R : Type u} [comm_ring R] {J : Type v}
    [category_theory.small_category J] (F : J ⥤ Algebra R) :
    category_theory.limits.is_limit
        (category_theory.functor.map_cone (category_theory.forget₂ (Algebra R) (Module R))
          (has_limits.limit_cone F)) :=
...
-/
protected instance forget₂_Module_preserves_limits {R : Type u} [comm_ring R] :
  ...
  category_theory.limits.preserves_limits.mk
    fun (J : Type v) (𝒥 : category_theory.small_category J) =>
      category_theory.limits.preserves_limits_of_shape.mk
        fun (F : J ⥤ Algebra R) =>
          category_theory.limits.preserves_limit_of_preserves_limit_cone
            (has_limits.limit_cone_is_limit F) (forget₂_Module_preserves_limits_aux F)

/--
The forgetful functor from R-algebras to types preserves all limits.
-/
protected instance forget_preserves_limits {R : Type u} [comm_ring R] :
        ...
        fun (F : J ⥤ Algebra R) =>
          category_theory.limits.preserves_limit_of_preserves_limit_cone
            ...
            (category_theory.limits.types.limit_cone_is_limit
              (F ⋙ category_theory.forget (Algebra R)))
