...
protected instance monoid_obj {J : Type u} [category_theory.small_category J] (F : J ⥤ Mon)
    (j : J) : monoid (category_theory.functor.obj (F ⋙ category_theory.forget Mon) j) :=
  id (Mon.monoid (category_theory.functor.obj F j))

/--
The flat sections of a functor into `Mon` form a submonoid of all sections.
-/
def Mathlib.AddMon.sections_add_submonoid {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddMon) : add_submonoid ((j : J) → ↥(category_theory.functor.obj F j)) :=
  add_submonoid.mk (category_theory.functor.sections (F ⋙ category_theory.forget AddMon)) sorry
    sorry

protected instance Mathlib.AddMon.limit_add_monoid {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddMon) :
    add_monoid
        (category_theory.limits.cone.X
          (category_theory.limits.types.limit_cone (F ⋙ category_theory.forget AddMon))) :=
  add_submonoid.to_add_monoid (AddMon.sections_add_submonoid F)

/-- `limit.π (F ⋙ forget Mon) j` as a `monoid_hom`. -/
def Mathlib.AddMon.limit_π_add_monoid_hom {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddMon) (j : J) :
    category_theory.limits.cone.X
          (category_theory.limits.types.limit_cone (F ⋙ category_theory.forget AddMon)) →+
...
-/
def Mathlib.AddMon.has_limits.limit_cone {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddMon) : category_theory.limits.cone F :=
...
(Internal use only; use the limits API.)
-/
def Mathlib.AddMon.has_limits.limit_cone_is_limit {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddMon) : category_theory.limits.is_limit (AddMon.has_limits.limit_cone F) :=
    ...
    (fun (s : category_theory.limits.cone F) =>
      add_monoid_hom.mk
        (fun
          (v :
          category_theory.limits.cone.X
            (category_theory.functor.map_cone (category_theory.forget AddMon) s)) =>
          { val :=
              fun (j : J) =>
                category_theory.nat_trans.app
                  (category_theory.limits.cone.π
...
-/
protected instance Mathlib.AddMon.forget_preserves_limits :
      ...
      category_theory.limits.preserves_limits_of_shape.mk
        fun (F : J ⥤ AddMon) =>
          category_theory.limits.preserves_limit_of_preserves_limit_cone
            (AddMon.has_limits.limit_cone_is_limit F)
            (category_theory.limits.types.limit_cone_is_limit (F ⋙ category_theory.forget AddMon))
...
protected instance comm_monoid_obj {J : Type u} [category_theory.small_category J] (F : J ⥤ CommMon)
    (j : J) : comm_monoid (category_theory.functor.obj (F ⋙ category_theory.forget CommMon) j) :=
  id (CommMon.comm_monoid (category_theory.functor.obj F j))

protected instance limit_comm_monoid {J : Type u} [category_theory.small_category J]
    (F : J ⥤ CommMon) :
    comm_monoid
        (category_theory.limits.cone.X
          (category_theory.limits.types.limit_cone (F ⋙ category_theory.forget CommMon))) :=
...
protected instance category_theory.forget₂.category_theory.creates_limit {J : Type u}
    [category_theory.small_category J] (F : J ⥤ CommMon) :
...
-/
def Mathlib.AddCommMon.limit_cone {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddCommMon) : category_theory.limits.cone F :=
...
-/
def Mathlib.AddCommMon.limit_cone_is_limit {J : Type u} [category_theory.small_category J]
    (F : J ⥤ AddCommMon) : category_theory.limits.is_limit (AddCommMon.limit_cone F) :=
...
protected instance has_limits : category_theory.limits.has_limits CommMon :=
  category_theory.limits.has_limits.mk
    fun (J : Type u_1) (𝒥 : category_theory.small_category J) =>
      category_theory.limits.has_limits_of_shape.mk
        fun (F : J ⥤ CommMon) =>
          category_theory.has_limit_of_created F (category_theory.forget₂ CommMon Mon)
...
of monoids.)
-/
protected instance Mathlib.AddCommMon.forget₂_AddMon_preserves_limits :
      ...
      category_theory.limits.preserves_limits_of_shape.mk
        fun (F : J ⥤ AddCommMon) =>
          category_theory.preserves_limit_of_creates_limit_and_has_limit F
            (category_theory.forget₂ AddCommMon AddMon)
...
protected instance forget_preserves_limits :
  ...
  category_theory.limits.preserves_limits.mk
    fun (J : Type u_1) (𝒥 : category_theory.small_category J) =>
      category_theory.limits.preserves_limits_of_shape.mk
        fun (F : J ⥤ CommMon) =>
          category_theory.limits.comp_preserves_limit (category_theory.forget₂ CommMon Mon)
