...
inductive prequotient {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) where
...
protected instance prequotient.inhabited {J : Type v} [category_theory.small_category J]
    (F : J ⥤ AddCommGroup) : Inhabited (prequotient F) :=
...
inductive relation {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) :
...
| neg :
    ∀ (j : J) (x : ↥(category_theory.functor.obj F j)),
...
| add :
    ∀ (j : J) (x y : ↥(category_theory.functor.obj F j)),
      relation F (prequotient.of j (x + y))
        (prequotient.add (prequotient.of j x) (prequotient.of j y))
| neg_1 :
    ∀ (x x' : prequotient F), relation F x x' → relation F (prequotient.neg x) (prequotient.neg x')
| add_1 :
    ∀ (x x' y : prequotient F),
      relation F x x' → relation F (prequotient.add x y) (prequotient.add x' y)
| add_2 :
    ∀ (x y y' : prequotient F),
      relation F y y' → relation F (prequotient.add x y) (prequotient.add x y')
...
| add_left_neg :
    ∀ (x : prequotient F), relation F (prequotient.add (prequotient.neg x) x) prequotient.zero
...
-/
instance colimit_setoid {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) :
...
protected instance colimit_type.add_comm_group {J : Type v} [category_theory.small_category J]
    (F : J ⥤ AddCommGroup) : add_comm_group (colimit_type F) :=
  add_comm_group.mk
    (Quot.lift
      (fun (x : prequotient F) =>
        Quot.lift (fun (y : prequotient F) => Quot.mk setoid.r (prequotient.add x y)) sorry)
      sorry)
...
@[simp] theorem quot_zero {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) :
    Quot.mk setoid.r prequotient.zero = 0 :=
  rfl

@[simp] theorem quot_neg {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup)
    (x : prequotient F) : Quot.mk setoid.r (prequotient.neg x) = -Quot.mk setoid.r x :=
  rfl

@[simp] theorem quot_add {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup)
    (x : prequotient F) (y : prequotient F) :
    Quot.mk setoid.r (prequotient.add x y) = Quot.mk setoid.r x + Quot.mk setoid.r y :=
  rfl
...
def cocone_fun {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) (j : J)
...
group. -/
def cocone_morphism {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) (j : J) :
    category_theory.functor.obj F j ⟶ colimit F :=
  add_monoid_hom.mk (cocone_fun F j) sorry sorry

@[simp] theorem cocone_naturality {J : Type v} [category_theory.small_category J]
    (F : J ⥤ AddCommGroup) {j : J} {j' : J} (f : j ⟶ j') :
    category_theory.functor.map F f ≫ cocone_morphism F j' = cocone_morphism F j :=
  ext (category_theory.functor.obj F j) (colimit F)
    (category_theory.functor.map F f ≫ cocone_morphism F j') (cocone_morphism F j)
    fun (x : ↥(category_theory.functor.obj F j)) => quot.sound (relation.map j j' f x)

@[simp] theorem cocone_naturality_components {J : Type v} [category_theory.small_category J]
    (F : J ⥤ AddCommGroup) (j : J) (j' : J) (f : j ⟶ j') (x : ↥(category_theory.functor.obj F j)) :
...
def colimit_cocone {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup) :
...
cocone. -/
@[simp] def desc_fun_lift {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup)
...
def desc_fun {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup)
...
def desc_morphism {J : Type v} [category_theory.small_category J] (F : J ⥤ AddCommGroup)
...
def colimit_cocone_is_colimit {J : Type v} [category_theory.small_category J]
    (F : J ⥤ AddCommGroup) : category_theory.limits.is_colimit (colimit_cocone F) :=
...
-/
def cokernel_iso_quotient {G : AddCommGroup} {H : AddCommGroup} (f : G ⟶ H) :
    category_theory.limits.cokernel f ≅ of (quotient_add_group.quotient (add_monoid_hom.range f)) :=
  category_theory.iso.mk
    (category_theory.limits.cokernel.desc f (quotient_add_group.mk' (add_monoid_hom.range f)) sorry)
    (add_monoid_hom.of
      ⇑(quotient_add_group.lift (add_monoid_hom.range f) (category_theory.limits.cokernel.π f)
          sorry))
