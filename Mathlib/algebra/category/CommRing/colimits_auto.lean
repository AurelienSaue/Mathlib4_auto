...
inductive prequotient {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) where
...
protected instance prequotient.inhabited {J : Type v} [category_theory.small_category J]
    (F : J ⥤ CommRing) : Inhabited (prequotient F) :=
...
inductive relation {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) :
...
| left_distrib :
    ∀ (x y z : prequotient F),
      relation F (prequotient.mul x (prequotient.add y z))
        (prequotient.add (prequotient.mul x y) (prequotient.mul x z))
| right_distrib :
    ∀ (x y z : prequotient F),
      relation F (prequotient.mul (prequotient.add x y) z)
        (prequotient.add (prequotient.mul x z) (prequotient.mul y z))
...
-/
instance colimit_setoid {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) :
...
protected instance colimit_type.comm_ring {J : Type v} [category_theory.small_category J]
    (F : J ⥤ CommRing) : comm_ring (colimit_type F) :=
  comm_ring.mk
    (Quot.lift
      (fun (x : prequotient F) =>
...
@[simp] theorem quot_zero {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) :
    Quot.mk setoid.r prequotient.zero = 0 :=
  rfl

@[simp] theorem quot_one {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) :
    Quot.mk setoid.r prequotient.one = 1 :=
  rfl

@[simp] theorem quot_neg {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
    (x : prequotient F) : Quot.mk setoid.r (prequotient.neg x) = -Quot.mk setoid.r x :=
  rfl

@[simp] theorem quot_add {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
    (x : prequotient F) (y : prequotient F) :
    Quot.mk setoid.r (prequotient.add x y) = Quot.mk setoid.r x + Quot.mk setoid.r y :=
  rfl

@[simp] theorem quot_mul {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
    (x : prequotient F) (y : prequotient F) :
...
def cocone_fun {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) (j : J)
...
ring. -/
def cocone_morphism {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) (j : J) :
    category_theory.functor.obj F j ⟶ colimit F :=
  ring_hom.mk (cocone_fun F j) sorry sorry sorry sorry

@[simp] theorem cocone_naturality {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
    {j : J} {j' : J} (f : j ⟶ j') :
...
@[simp] theorem cocone_naturality_components {J : Type v} [category_theory.small_category J]
    (F : J ⥤ CommRing) (j : J) (j' : J) (f : j ⟶ j') (x : ↥(category_theory.functor.obj F j)) :
    coe_fn (cocone_morphism F j') (coe_fn (category_theory.functor.map F f) x) =
        coe_fn (cocone_morphism F j) x :=
  sorry

/-- The cocone over the proposed colimit commutative ring. -/
def colimit_cocone {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) :
...
cocone. -/
@[simp] def desc_fun_lift {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
...
def desc_fun {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
...
cocone. -/
def desc_morphism {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing)
...
def colimit_is_colimit {J : Type v} [category_theory.small_category J] (F : J ⥤ CommRing) :
