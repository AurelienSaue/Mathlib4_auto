...
in general. -/
structure basic_smooth_bundle_core {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    ...
    [smooth_manifold_with_corners I M] (F : Type u_5) [normed_group F] [normed_space 𝕜 F]
    where
  coord_change : ↥(charted_space.atlas H M) → ↥(charted_space.atlas H M) → H → F → F
  coord_change_self :
    ∀ (i : ↥(charted_space.atlas H M)) (x : H),
      x ∈ local_equiv.target (local_homeomorph.to_local_equiv (subtype.val i)) →
        ∀ (v : F), coord_change i i x v = v
  coord_change_comp :
    ∀ (i j k : ↥(charted_space.atlas H M)) (x : H),
      x ∈
          local_equiv.source
        ...
        ∀ (v : F),
          coord_change j k
              (coe_fn
                (local_homeomorph.trans (local_homeomorph.symm (subtype.val i)) (subtype.val j)) x)
              (coord_change i j x v) =
            coord_change i k x v
  coord_change_smooth :
    ∀ (i j : ↥(charted_space.atlas H M)),
      times_cont_diff_on 𝕜 ⊤
        (fun (p : E × F) =>
          coord_change i j (coe_fn (model_with_corners.symm I) (prod.fst p)) (prod.snd p))
        (set.prod
          (⇑I ''
            local_equiv.source
              (local_homeomorph.to_local_equiv
...
identity. -/
def trivial_basic_smooth_bundle_core {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    (I : model_with_corners 𝕜 E H) (M : Type u_4) [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] (F : Type u_5) [normed_group F] [normed_space 𝕜 F] :
    basic_smooth_bundle_core I M F :=
  basic_smooth_bundle_core.mk (fun (i j : ↥(charted_space.atlas H M)) (x : H) (v : F) => v) sorry
    sorry sorry

namespace basic_smooth_bundle_core


protected instance inhabited {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F] :
    Inhabited (basic_smooth_bundle_core I M F) :=
  { default := trivial_basic_smooth_bundle_core I M F }

/-- Fiber bundle core associated to a basic smooth bundle core -/
def to_topological_fiber_bundle_core {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F) :
    topological_fiber_bundle_core (↥(charted_space.atlas H M)) M F :=
  topological_fiber_bundle_core.mk
    (fun (i : ↥(charted_space.atlas H M)) =>
      local_equiv.source (local_homeomorph.to_local_equiv (subtype.val i)))
    sorry
    (fun (x : M) =>
      { val := charted_space.chart_at H x, property := charted_space.chart_mem_atlas H x })
    sorry
    (fun (i j : ↥(charted_space.atlas H M)) (x : M) (v : F) =>
      coord_change Z i j (coe_fn (subtype.val i) x) v)
    sorry sorry sorry

@[simp] theorem base_set {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2} [normed_group E]
    [normed_space 𝕜 E] {H : Type u_3} [topological_space H] {I : model_with_corners 𝕜 E H}
    {M : Type u_4} [topological_space M] [charted_space H M] [smooth_manifold_with_corners I M]
    {F : Type u_5} [normed_group F] [normed_space 𝕜 F] (Z : basic_smooth_bundle_core I M F)
    (i : ↥(charted_space.atlas H M)) :
    topological_fiber_bundle_core.base_set (to_topological_fiber_bundle_core Z) i =
        local_equiv.source (local_homeomorph.to_local_equiv (subtype.val i)) :=
  rfl

/-- Local chart for the total space of a basic smooth bundle -/
def chart {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2} [normed_group E]
    [normed_space 𝕜 E] {H : Type u_3} [topological_space H] {I : model_with_corners 𝕜 E H}
    {M : Type u_4} [topological_space M] [charted_space H M] [smooth_manifold_with_corners I M]
    {F : Type u_5} [normed_group F] [normed_space 𝕜 F] (Z : basic_smooth_bundle_core I M F)
    {e : local_homeomorph M H} (he : e ∈ charted_space.atlas H M) :
    local_homeomorph
        (topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z))
        (model_prod H F) :=
  local_homeomorph.trans
    (topological_fiber_bundle_core.local_triv (to_topological_fiber_bundle_core Z)
      { val := e, property := he })
    (local_homeomorph.prod e (local_homeomorph.refl F))

@[simp] theorem chart_source {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F) (e : local_homeomorph M H)
    (he : e ∈ charted_space.atlas H M) :
    local_equiv.source (local_homeomorph.to_local_equiv (chart Z he)) =
...
@[simp] theorem chart_target {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F) (e : local_homeomorph M H)
    (he : e ∈ charted_space.atlas H M) :
    local_equiv.target (local_homeomorph.to_local_equiv (chart Z he)) =
        set.prod (local_equiv.target (local_homeomorph.to_local_equiv e)) set.univ :=
  sorry
...
protected instance to_charted_space {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F) :
    charted_space (model_prod H F)
        (topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z)) :=
  charted_space.mk
    (set.Union
      fun (e : local_homeomorph M H) =>
        set.Union fun (he : e ∈ charted_space.atlas H M) => singleton (chart Z he))
    (fun (p : topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z)) =>
      chart Z sorry)
    sorry sorry

theorem mem_atlas_iff {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2} [normed_group E]
    [normed_space 𝕜 E] {H : Type u_3} [topological_space H] {I : model_with_corners 𝕜 E H}
    {M : Type u_4} [topological_space M] [charted_space H M] [smooth_manifold_with_corners I M]
    {F : Type u_5} [normed_group F] [normed_space 𝕜 F] (Z : basic_smooth_bundle_core I M F)
    (f :
      local_homeomorph
        ...
        (model_prod H F)) :
    f ∈
          charted_space.atlas (model_prod H F)
            (topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z)) ↔
        ∃ (e : local_homeomorph M H), ∃ (he : e ∈ charted_space.atlas H M), f = chart Z he :=
  sorry

@[simp] theorem mem_chart_source_iff {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F)
    (p : topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z))
    (q : topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z)) :
    p ∈
          local_equiv.source
            (local_homeomorph.to_local_equiv (charted_space.chart_at (model_prod H F) q)) ↔
        sigma.fst p ∈
          local_equiv.source
            (local_homeomorph.to_local_equiv (charted_space.chart_at H (sigma.fst q))) :=
  sorry

@[simp] theorem mem_chart_target_iff {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F) (p : H × F)
    (q : topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z)) :
    p ∈
          local_equiv.target
            (local_homeomorph.to_local_equiv (charted_space.chart_at (model_prod H F) q)) ↔
...
@[simp] theorem coe_chart_at_fst {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u_2}
    [normed_group E] [normed_space 𝕜 E] {H : Type u_3} [topological_space H]
    {I : model_with_corners 𝕜 E H} {M : Type u_4} [topological_space M] [charted_space H M]
    [smooth_manifold_with_corners I M] {F : Type u_5} [normed_group F] [normed_space 𝕜 F]
    (Z : basic_smooth_bundle_core I M F)
    (p : topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z))
    (q : topological_fiber_bundle_core.total_space (to_topological_fiber_bundle_core Z)) :
    prod.fst (coe_fn (charted_space.chart_at (model_prod H F) q) p) =
        coe_fn (charted_space.chart_at H (sigma.fst q)) (sigma.fst p) :=
  rfl

@[simp] theorem coe_chart_at_symm_fst {𝕜 : Type u_1} [nondiscrete_normed_field 𝕜] {E : Type u