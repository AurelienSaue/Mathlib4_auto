...
def code : coord → ℕ := sorry

protected def repr : coord → string := sorry

protected instance has_repr : has_repr coord := has_repr.mk coord.repr

protected instance has_to_string : has_to_string coord := has_to_string.mk coord.repr

protected instance has_lt : HasLess coord := { Less := fun (x y : coord) => code x < code y }
...
protected def to_string : address → string := to_string ∘ list.map coord.repr

protected instance has_repr : has_repr address := has_repr.mk address.to_string

protected instance has_to_string : has_to_string address := has_to_string.mk address.to_string

protected instance has_append : Append address := { append := list.append }
