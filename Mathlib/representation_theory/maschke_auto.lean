...
-/
def conjugate {k : Type u} [comm_ring k] {G : Type u} [group G] {V : Type u} [add_comm_group V]
    [module k V] [module (monoid_algebra k G) V] [is_scalar_tower k (monoid_algebra k G) V]
    {W : Type u} [add_comm_group W] [module k W] [module (monoid_algebra k G) W]
    [is_scalar_tower k (monoid_algebra k G) W] (π : linear_map k W V) (g : G) : linear_map k W V :=
  comp (comp (monoid_algebra.group_smul.linear_map k V (g⁻¹)) π)
    (monoid_algebra.group_smul.linear_map k W g)

theorem conjugate_i {k : Type u} [comm_ring k] {G : Type u} [group G] {V : Type u}
    [add_comm_group V] [module k V] [module (monoid_algebra k G) V]
    [is_scalar_tower k (monoid_algebra k G) V] {W : Type u} [add_comm_group W] [module k W]
    [module (monoid_algebra k G) W] [is_scalar_tower k (monoid_algebra k G) W]
    (π : linear_map k W V) (i : linear_map (monoid_algebra k G) V W)
    (h : ∀ (v : V), coe_fn π (coe_fn i v) = v) (g : G) (v : V) :
    coe_fn (conjugate π g) (coe_fn i v) = v :=
  sorry
...
-/
def sum_of_conjugates {k : Type u} [comm_ring k] (G : Type u) [group G] {V : Type u}
    [add_comm_group V] [module k V] [module (monoid_algebra k G) V]
    [is_scalar_tower k (monoid_algebra k G) V] {W : Type u} [add_comm_group W] [module k W]
    [module (monoid_algebra k G) W] [is_scalar_tower k (monoid_algebra k G) W]
    (π : linear_map k W V) [fintype G] : linear_map k W V :=
  finset.sum finset.univ fun (g : G) => conjugate π g

/--
In fact, the sum over `g : G` of the conjugate of `π` by `g` is a `k[G]`-linear map.
-/
def sum_of_conjugates_equivariant {k : Type u} [comm_ring k] (G : Type u) [group G] {V : Type u}
    [add_comm_group V] [module k V] [module (monoid_algebra k G) V]
    [is_scalar_tower k (monoid_algebra k G) V] {W : Type u} [add_comm_group W] [module k W]
    [module (monoid_algebra k G) W] [is_scalar_tower k (monoid_algebra k G) W]
    (π : linear_map k W V) [fintype G] : linear_map (monoid_algebra k G) W V :=
...
$$ \frac{1}{|G|} \sum_{g \in G} g⁻¹ • π(g • -). $$
-/
def equivariant_projection {k : Type u} [comm_ring k] (G : Type u) [group G] {V : Type u}
    [add_comm_group V] [module k V] [module (monoid_algebra k G) V]
    [is_scalar_tower k (monoid_algebra k G) V] {W : Type u} [add_comm_group W] [module k W]
    [module (monoid_algebra k G) W] [is_scalar_tower k (monoid_algebra k G) W]
    (π : linear_map k W V) [fintype G] [inv : invertible ↑(fintype.card G)] :
    linear_map (monoid_algebra k G) W V :=
  ⅟ • sum_of_conjugates_equivariant G π

theorem equivariant_projection_condition {k : Type u} [comm_ring k] (G : Type u) [group G]
    {V : Type u} [add_comm_group V] [module k V] [module (monoid_algebra k G) V]
    [is_scalar_tower k (monoid_algebra k G) V] {W : Type u} [add_comm_group W] [module k W]
    [module (monoid_algebra k G) W] [is_scalar_tower k (monoid_algebra k G) W]
    (π : linear_map k W V) (i : linear_map (monoid_algebra k G) V W)
    (h : ∀ (v : V), coe_fn π (coe_fn i v) = v) [fintype G] [inv : invertible ↑(fintype.card G)]
    (v : V) : coe_fn (equivariant_projection G π) (coe_fn i v) = v :=
  sorry
...
theorem monoid_algebra.exists_left_inverse_of_injective {k : Type u} [field k] {G : Type u}
    [fintype G] [group G] {V : Type u} [add_comm_group V] [module k V]
    [module (monoid_algebra k G) V] [is_scalar_tower k (monoid_algebra k G) V] {W : Type u}
    [add_comm_group W] [module k W] [module (monoid_algebra k G) W]
    [is_scalar_tower k (monoid_algebra k G) W] (not_dvd : ¬ring_char k ∣ fintype.card G)
    (f : linear_map (monoid_algebra k G) V W) (hf : linear_map.ker f = ⊥) :
    ∃ (g : linear_map (monoid_algebra k G) W V), linear_map.comp g f = linear_map.id :=
  sorry

theorem monoid_algebra.submodule.exists_is_compl {k : Type u} [field k] {G : Type u} [fintype G]
    [group G] {V : Type u} [add_comm_group V] [module k V] [module (monoid_algebra k G) V]
    [is_scalar_tower k (monoid_algebra k G) V] (not_dvd : ¬ring_char k ∣ fintype.card G)
