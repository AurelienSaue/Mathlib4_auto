...
-/
class preserves_limit {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
...
-/
class preserves_colimit {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) (F : C ⥤ D)
    where
...
class preserves_limits_of_shape {C : Type u₁} [category C] {D : Type u₂} [category D] (J : Type v)
...
class preserves_colimits_of_shape {C : Type u₁} [category C] {D : Type u₂} [category D] (J : Type v)
    [small_category J] (F : C ⥤ D)
    where
...
class preserves_limits {C : Type u₁} [category C] {D : Type u₂} [category D] (F : C ⥤ D) where
...
/-- We say that `F` preserves colimits if it sends colimit cocones over any diagram to colimit
    cocones.-/
class preserves_colimits {C : Type u₁} [category C] {D : Type u₂} [category D] (F : C ⥤ D) where
...
-/
def is_limit_of_preserves {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] {K : J ⥤ C} (F : C ⥤ D) {c : cone K} (t : is_limit c) [preserves_limit K F] :
    is_limit (functor.map_cone F c) :=
...
guide typeclass resolution.
-/
def is_colimit_of_preserves {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] {K : J ⥤ C} (F : C ⥤ D) {c : cocone K} (t : is_colimit c)
    [preserves_colimit K F] : is_colimit (functor.map_cocone F c) :=
  preserves_colimit.preserves t

protected instance preserves_limit_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] (K : J ⥤ C) (F : C ⥤ D) :
        ...
        fun (a : {c : cone K} → is_limit c → is_limit (functor.map_cone F c)) =>
          preserves_limit.cases_on b
            fun (b : {c : cone K} → is_limit c → is_limit (functor.map_cone F c)) =>
              (fun {K : J ⥤ C} {F : C ⥤ D}
                  (preserves preserves_1 :
                  {c : cone K} → is_limit c → is_limit (functor.map_cone F c)) =>
                  Eq.trans
                    ((fun {K : J ⥤ C} {F : C ⥤ D}
                        (preserves : {c : cone K} → is_limit c → is_limit (functor.map_cone F c)) =>
...
protected instance preserves_colimit_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] (K : J ⥤ C) (F : C ⥤ D) :
        ...
        fun (a : {c : cocone K} → is_colimit c → is_colimit (functor.map_cocone F c)) =>
          preserves_colimit.cases_on b
            fun (b : {c : cocone K} → is_colimit c → is_colimit (functor.map_cocone F c)) =>
              (fun {K : J ⥤ C} {F : C ⥤ D}
                  (preserves preserves_1 :
                  {c : cocone K} → is_colimit c → is_colimit (functor.map_cocone F c)) =>
                  Eq.trans
                    ((fun {K : J ⥤ C} {F : C ⥤ D}
                        (preserves :
                        {c : cocone K} → is_colimit c → is_colimit (functor.map_cocone F c)) =>
                      ...
                      preserves)
                    (congr (Eq.refl preserves_colimit.mk)
                      (subsingleton.elim preserves preserves_1)))
                a b

protected instance preserves_limits_of_shape_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (J : Type v) [small_category J] (F : C ⥤ D) :
              ...
              (fun [_inst_4 : small_category J] {F : C ⥤ D}
                  ...
                  Eq.trans
                    ((fun [_inst_4 : small_category J] {F : C ⥤ D}
                      ...
                      preserves_limit)
                    (congr (Eq.refl preserves_limits_of_shape.mk)
                      (subsingleton.elim preserves_limit preserves_limit_1)))
                a b

protected instance preserves_colimits_of_shape_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (J : Type v) [small_category J] (F : C ⥤ D) :
...
protected instance preserves_limits_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (F : C ⥤ D) : subsingleton (preserves_limits F) :=
  subsingleton.intro
...
protected instance preserves_colimits_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (F : C ⥤ D) : subsingleton (preserves_colimits F) :=
  subsingleton.intro
                ...
                (eq_true_intro
                  (eq_of_heq
                    ((fun
                        ...
                        Eq._oldrec (HEq.refl (preserves_colimits.mk preserves_colimits_of_shape))
                          e_0)
                      a b (Eq.symm (subsingleton.elim b a)))))
          ...
          preserves_limit.mk
            fun (c : cone K) (h : is_limit c) =>
              is_limit.mk
                fun (s : cone (K ⋙ 𝟭)) =>
                  is_limit.lift h
                    (cone.mk (cone.X s) (nat_trans.mk fun (j : J) => nat_trans.app (cone.π s) j))
          ...
          preserves_colimit.mk
            fun (c : cocone K) (h : is_colimit c) =>
              is_colimit.mk
                fun (s : cocone (K ⋙ 𝟭)) =>
                  is_colimit.desc h
                    (cocone.mk (cocone.X s)
                      (nat_trans.mk fun (j : J) => nat_trans.app (cocone.ι s) j))

protected instance comp_preserves_limit {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_limit K F] [preserves_limit (K ⋙ F) G] : preserves_limit K (F ⋙ G) :=
  preserves_limit.mk
    fun (c : cone K) (h : is_limit c) => preserves_limit.preserves (preserves_limit.preserves h)

protected instance comp_preserves_limits_of_shape {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_limits_of_shape J F] [preserves_limits_of_shape J G] :
    preserves_limits_of_shape J (F ⋙ G) :=
  preserves_limits_of_shape.mk fun (K : J ⥤ C) => infer_instance

protected instance comp_preserves_limits {C : Type u₁} [category C] {D : Type u₂} [category D]
    {E : Type u₃} [ℰ : category E] (F : C ⥤ D) (G : D ⥤ E) [preserves_limits F]
    [preserves_limits G] : preserves_limits (F ⋙ G) :=
  preserves_limits.mk fun (J : Type v) (𝒥₁ : small_category J) => infer_instance

protected instance comp_preserves_colimit {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_colimit K F] [preserves_colimit (K ⋙ F) G] :
    preserves_colimit K (F ⋙ G) :=
  preserves_colimit.mk
    fun (c : cocone K) (h : is_colimit c) =>
      preserves_colimit.preserves (preserves_colimit.preserves h)

protected instance comp_preserves_colimits_of_shape {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_colimits_of_shape J F] [preserves_colimits_of_shape J G] :
    preserves_colimits_of_shape J (F ⋙ G) :=
  preserves_colimits_of_shape.mk fun (K : J ⥤ C) => infer_instance

protected instance comp_preserves_colimits {C : Type u₁} [category C] {D : Type u₂} [category D]
    {E : Type u₃} [ℰ : category E] (F : C ⥤ D) (G : D ⥤ E) [preserves_colimits F]
    [preserves_colimits G] : preserves_colimits (F ⋙ G) :=
  preserves_colimits.mk fun (J : Type v) (𝒥₁ : small_category J) => infer_instance

/-- If F preserves one limit cone for the diagram K,
  then it preserves any limit cone for K. -/
def preserves_limit_of_preserves_limit_cone {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {F : C ⥤ D} {t : cone K} (h : is_limit t)
    (hF : is_limit (functor.map_cone F t)) : preserves_limit K F :=
  preserves_limit.mk
    fun (t' : cone K) (h' : is_limit t') =>
      is_limit.of_iso_limit hF
        (functor.map_iso (cones.functoriality K F) (is_limit.unique_up_to_iso h h'))

/-- Transfer preservation of limits along a natural isomorphism in the diagram. -/
def preserves_limit_of_iso_diagram {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K₁ : J ⥤ C} {K₂ : J ⥤ C} (F : C ⥤ D) (h : K₁ ≅ K₂)
    ...
    fun (c : cone K₂) (t : is_limit c) =>
      coe_fn (is_limit.postcompose_inv_equiv (iso_whisker_right h F) (functor.map_cone F c))
        (is_limit.of_iso_limit
          (is_limit_of_preserves F (coe_fn (equiv.symm (is_limit.postcompose_inv_equiv h c)) t))
          (cones.ext
            (iso.refl (cone.X (functor.map_cone F (functor.obj (cones.postcompose (iso.inv h)) c))))
            sorry))

/-- Transfer preservation of a limit along a natural isomorphism in the functor. -/
def preserves_limit_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G) [preserves_limit K F] :
    preserves_limit K G :=
  preserves_limit.mk
    fun (c : cone K) (t : is_limit c) => is_limit.map_cone_equiv h (preserves_limit.preserves t)

/-- Transfer preservation of limits of shape along a natural isomorphism in the functor. -/
def preserves_limits_of_shape_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D]
...
def preserves_limits_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {F : C ⥤ D}
    {G : C ⥤ D} (h : F ≅ G) [preserves_limits F] : preserves_limits G :=
  preserves_limits.mk
    fun (J : Type v) (𝒥₁ : small_category J) => preserves_limits_of_shape_of_nat_iso h

/-- Transfer preservation of limits along a equivalence in the shape. -/
def preserves_limits_of_shape_of_equiv {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {J' : Type v} [small_category J'] (e : J ≌ J') (F : C ⥤ D)
        ...
        fun (c : cone K) (t : is_limit c) =>
          ...
          is_limit.of_iso_limit
            (coe_fn
              ...
              (is_limit.whisker_equivalence
                (is_limit_of_preserves F (is_limit.whisker_equivalence t e)) (equivalence.symm e)))
            (cones.ext
              (iso.refl
                (cone.X
...
def preserves_colimit_of_preserves_colimit_cocone {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {K : J ⥤ C} {F : C ⥤ D} {t : cocone K}
    (h : is_colimit t) (hF : is_colimit (functor.map_cocone F t)) : preserves_colimit K F :=
  preserves_colimit.mk
    fun (t' : cocone K) (h' : is_colimit t') =>
      is_colimit.of_iso_colimit hF
        (functor.map_iso (cocones.functoriality K F) (is_colimit.unique_up_to_iso h h'))

/-- Transfer preservation of colimits along a natural isomorphism in the shape. -/
def preserves_colimit_of_iso_diagram {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K₁ : J ⥤ C} {K₂ : J ⥤ C} (F : C ⥤ D) (h : K₁ ≅ K₂)
    ...
    fun (c : cocone K₂) (t : is_colimit c) =>
      coe_fn (is_colimit.precompose_hom_equiv (iso_whisker_right h F) (functor.map_cocone F c))
        (is_colimit.of_iso_colimit
          ...
          (cocones.ext
            (iso.refl
              (cocone.X (functor.map_cocone F (functor.obj (cocones.precompose (iso.hom h)) c))))
            sorry))

/-- Transfer preservation of a colimit along a natural isomorphism in the functor. -/
def preserves_colimit_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G) [preserves_colimit K F] :
    preserves_colimit K G :=
  preserves_colimit.mk
    fun (c : cocone K) (t : is_colimit c) =>
      is_colimit.map_cocone_equiv h (preserves_colimit.preserves t)

/-- Transfer preservation of colimits of shape along a natural isomorphism in the functor. -/
def preserves_colimits_of_shape_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G)
...
def preserves_colimits_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {F : C ⥤ D}
    {G : C ⥤ D} (h : F ≅ G) [preserves_colimits F] : preserves_colimits G :=
  preserves_colimits.mk
    fun (J : Type v) (𝒥₁ : small_category J) => preserves_colimits_of_shape_of_nat_iso h

/-- Transfer preservation of colimits along a equivalence in the shape. -/
def preserves_colimits_of_shape_of_equiv {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {J' : Type v} [small_category J'] (e : J ≌ J') (F : C ⥤ D)
...
-/
class reflects_limit {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) (F : C ⥤ D)
    where
...
-/
class reflects_colimit {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) (F : C ⥤ D)
    where
...
Note that we do not assume a priori that `D` actually has any limits.
-/
class reflects_limits_of_shape {C : Type u₁} [category C] {D : Type u₂} [category D] (J : Type v)
    [small_category J] (F : C ⥤ D)
    where
...
Note that we do not assume a priori that `D` actually has any colimits.
-/
class reflects_colimits_of_shape {C : Type u₁} [category C] {D : Type u₂} [category D] (J : Type v)
    [small_category J] (F : C ⥤ D)
    where
...
Note that we do not assume a priori that `D` actually has any limits.
-/
class reflects_limits {C : Type u₁} [category C] {D : Type u₂} [category D] (F : C ⥤ D) where
...
Note that we do not assume a priori that `D` actually has any colimits.
-/
class reflects_colimits {C : Type u₁} [category C] {D : Type u₂} [category D] (F : C ⥤ D) where
  reflects_colimits_of_shape :
...
guide typeclass resolution.
-/
def is_limit_of_reflects {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] {K : J ⥤ C} (F : C ⥤ D) {c : cone K} (t : is_limit (functor.map_cone F c))
...
guide typeclass resolution.
-/
def is_colimit_of_reflects {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] {K : J ⥤ C} (F : C ⥤ D) {c : cocone K}
    (t : is_colimit (functor.map_cocone F c)) [reflects_colimit K F] : is_colimit c :=
  reflects_colimit.reflects t

protected instance reflects_limit_subsingleton {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] (K : J ⥤ C) (F : C ⥤ D) : subsingleton (reflects_limit K F) :=
  subsingleton.intro
        ...
        fun (a : {c : cone K} → is_limit (functor.map_cone F c) → is_limit c) =>
          reflects_limit.cases_on b
            fun (b : {c : cone K} → is_limit (functor.map_cone F c) → is_limit c) =>
              (fun {K : J ⥤ C} {F : C ⥤ D}
                  (reflects reflects_1 :
                  {c : cone K} → is_limit (functor.map_cone F c) → is_limit c) =>
                  Eq.trans
                    ((fun {K : J ⥤ C} {F : C ⥤ D}
                        (reflects : {c : cone K} → is_limit (functor.map_cone F c) → is_limit c) =>
...
protected instance reflects_colimit_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] (K : J ⥤ C) (F : C ⥤ D) :
        ...
        fun (a : {c : cocone K} → is_colimit (functor.map_cocone F c) → is_colimit c) =>
          reflects_colimit.cases_on b
            fun (b : {c : cocone K} → is_colimit (functor.map_cocone F c) → is_colimit c) =>
              (fun {K : J ⥤ C} {F : C ⥤ D}
                  (reflects reflects_1 :
                  {c : cocone K} → is_colimit (functor.map_cocone F c) → is_colimit c) =>
                  Eq.trans
                    ((fun {K : J ⥤ C} {F : C ⥤ D}
                        (reflects :
                        {c : cocone K} → is_colimit (functor.map_cocone F c) → is_colimit c) =>
...
protected instance reflects_limits_of_shape_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (J : Type v) [small_category J] (F : C ⥤ D) :
              ...
              (fun [_inst_4 : small_category J] {F : C ⥤ D}
                  ...
                  Eq.trans
                    ((fun [_inst_4 : small_category J] {F : C ⥤ D}
                      ...
                      reflects_limit)
                    (congr (Eq.refl reflects_limits_of_shape.mk)
                      (subsingleton.elim reflects_limit reflects_limit_1)))
                a b

protected instance reflects_colimits_of_shape_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (J : Type v) [small_category J] (F : C ⥤ D) :
...
protected instance reflects_limits_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (F : C ⥤ D) : subsingleton (reflects_limits F) :=
  subsingleton.intro
...
protected instance reflects_colimits_subsingleton {C : Type u₁} [category C] {D : Type u₂}
    [category D] (F : C ⥤ D) : subsingleton (reflects_colimits F) :=
  subsingleton.intro
...
protected instance reflects_limit_of_reflects_limits_of_shape {C : Type u₁} [category C]
...
protected instance reflects_colimit_of_reflects_colimits_of_shape {C : Type u₁} [category C]
    {D : Type u₂} [category D] {J : Type v} [small_category J] (K : J ⥤ C) (F : C ⥤ D)
    [H : reflects_colimits_of_shape J F] : reflects_colimit K F :=
  reflects_colimits_of_shape.reflects_colimit

protected instance reflects_limits_of_shape_of_reflects_limits {C : Type u₁} [category C]
    {D : Type u₂} [category D] {J : Type v} [small_category J] (F : C ⥤ D) [H : reflects_limits F] :
    reflects_limits_of_shape J F :=
  reflects_limits.reflects_limits_of_shape

protected instance reflects_colimits_of_shape_of_reflects_colimits {C : Type u₁} [category C]
    {D : Type u₂} [category D] {J : Type v} [small_category J] (F : C ⥤ D)
...
protected instance comp_reflects_limit {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [reflects_limit K F] [reflects_limit (K ⋙ F) G] : reflects_limit K (F ⋙ G) :=
  reflects_limit.mk
    fun (c : cone K) (h : is_limit (functor.map_cone (F ⋙ G) c)) =>
      reflects_limit.reflects (reflects_limit.reflects h)

protected instance comp_reflects_limits_of_shape {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [reflects_limits_of_shape J F] [reflects_limits_of_shape J G] :
    reflects_limits_of_shape J (F ⋙ G) :=
  reflects_limits_of_shape.mk fun (K : J ⥤ C) => infer_instance

protected instance comp_reflects_limits {C : Type u₁} [category C] {D : Type u₂} [category D]
    {E : Type u₃} [ℰ : category E] (F : C ⥤ D) (G : D ⥤ E) [reflects_limits F] [reflects_limits G] :
    reflects_limits (F ⋙ G) :=
  reflects_limits.mk fun (J : Type v) (𝒥₁ : small_category J) => infer_instance

protected instance comp_reflects_colimit {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [reflects_colimit K F] [reflects_colimit (K ⋙ F) G] : reflects_colimit K (F ⋙ G) :=
  reflects_colimit.mk
    fun (c : cocone K) (h : is_colimit (functor.map_cocone (F ⋙ G) c)) =>
      reflects_colimit.reflects (reflects_colimit.reflects h)

protected instance comp_reflects_colimits_of_shape {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [reflects_colimits_of_shape J F] [reflects_colimits_of_shape J G] :
    reflects_colimits_of_shape J (F ⋙ G) :=
  reflects_colimits_of_shape.mk fun (K : J ⥤ C) => infer_instance

protected instance comp_reflects_colimits {C : Type u₁} [category C] {D : Type u₂} [category D]
    {E : Type u₃} [ℰ : category E] (F : C ⥤ D) (G : D ⥤ E) [reflects_colimits F]
    [reflects_colimits G] : reflects_colimits (F ⋙ G) :=
...
def preserves_limit_of_reflects_of_preserves {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_limit K (F ⋙ G)] [reflects_limit (K ⋙ F) G] : preserves_limit K F :=
  preserves_limit.mk
    fun (c : cone K) (h : is_limit c) => is_limit_of_reflects G (is_limit_of_preserves (F ⋙ G) h)

/--
If `F ⋙ G` preserves limits of shape `J` and `G` reflects limits of shape `J`, then `F` preserves
limits of shape `J`.
-/
def preserves_limits_of_shape_of_reflects_of_preserves {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_limits_of_shape J (F ⋙ G)] [reflects_limits_of_shape J G] :
...
def preserves_limits_of_reflects_of_preserves {C : Type u₁} [category C] {D : Type u₂} [category D]
    {E : Type u₃} [ℰ : category E] (F : C ⥤ D) (G : D ⥤ E) [preserves_limits (F ⋙ G)]
    [reflects_limits G] : preserves_limits F :=
  preserves_limits.mk
    fun (J : Type v) (𝒥₁ : small_category J) =>
      preserves_limits_of_shape_of_reflects_of_preserves F G

/-- Transfer reflection of a limit along a natural isomorphism in the functor. -/
def reflects_limit_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G) [reflects_limit K F] :
    reflects_limit K G :=
  reflects_limit.mk
...
def reflects_limits_of_shape_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G)
...
def reflects_limits_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {F : C ⥤ D}
    {G : C ⥤ D} (h : F ≅ G) [reflects_limits F] : reflects_limits G :=
  reflects_limits.mk
    fun (J : Type v) (𝒥₁ : small_category J) => reflects_limits_of_shape_of_nat_iso h

/--
If the limit of `F` exists and `G` preserves it, then if `G` reflects isomorphisms then it
reflects the limit of `F`.
-/
def reflects_limit_of_reflects_isomorphisms {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] (F : J ⥤ C) (G : C ⥤ D) [reflects_isomorphisms G] [has_limit F]
    [preserves_limit F G] : reflects_limit F G :=
  reflects_limit.mk
    fun (c : cone F) (t : is_limit (functor.map_cone G c)) =>
      is_limit.of_point_iso (limit.is_limit F)

/--
If `C` has limits of shape `J` and `G` preserves them, then if `G` reflects isomorphisms then it
reflects limits of shape `J`.
-/
def reflects_limits_of_shape_of_reflects_isomorphisms {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {G : C ⥤ D} [reflects_isomorphisms G]
    [has_limits_of_shape J C] [preserves_limits_of_shape J G] : reflects_limits_of_shape J G :=
...
limits.
-/
def reflects_limits_of_reflects_isomorphisms {C : Type u₁} [category C] {D : Type u₂} [category D]
    {G : C ⥤ D} [reflects_isomorphisms G] [has_limits C] [preserves_limits G] : reflects_limits G :=
  reflects_limits.mk
    fun (J : Type v) (𝒥₁ : small_category J) => reflects_limits_of_shape_of_reflects_isomorphisms

/-- If `F ⋙ G` preserves colimits for `K`, and `G` reflects colimits for `K ⋙ F`,
then `F` preserves colimits for `K`. -/
def preserves_colimit_of_reflects_of_preserves {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {K : J ⥤ C} {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_colimit K (F ⋙ G)] [reflects_colimit (K ⋙ F) G] :
    preserves_colimit K F :=
  preserves_colimit.mk
    fun (c : cocone K) (h : is_colimit c) =>
      is_colimit_of_reflects G (is_colimit_of_preserves (F ⋙ G) h)

/--
If `F ⋙ G` preserves colimits of shape `J` and `G` reflects colimits of shape `J`, then `F`
preserves colimits of shape `J`.
-/
def preserves_colimits_of_shape_of_reflects_of_preserves {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {E : Type u₃} [ℰ : category E] (F : C ⥤ D)
    (G : D ⥤ E) [preserves_colimits_of_shape J (F ⋙ G)] [reflects_colimits_of_shape J G] :
...
def preserves_colimits_of_reflects_of_preserves {C : Type u₁} [category C] {D : Type u₂}
    [category D] {E : Type u₃} [ℰ : category E] (F : C ⥤ D) (G : D ⥤ E) [preserves_colimits (F ⋙ G)]
...
def reflects_colimit_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {J : Type v}
    [small_category J] (K : J ⥤ C) {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G) [reflects_colimit K F] :
...
def reflects_colimits_of_shape_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] {F : C ⥤ D} {G : C ⥤ D} (h : F ≅ G)
...
def reflects_colimits_of_nat_iso {C : Type u₁} [category C] {D : Type u₂} [category D] {F : C ⥤ D}
    {G : C ⥤ D} (h : F ≅ G) [reflects_colimits F] : reflects_colimits G :=
  reflects_colimits.mk
    fun (J : Type v) (𝒥₁ : small_category J) => reflects_colimits_of_shape_of_nat_iso h

/--
If the colimit of `F` exists and `G` preserves it, then if `G` reflects isomorphisms then it
reflects the colimit of `F`.
-/
def reflects_colimit_of_reflects_isomorphisms {C : Type u₁} [category C] {D : Type u₂} [category D]
    {J : Type v} [small_category J] (F : J ⥤ C) (G : C ⥤ D) [reflects_isomorphisms G]
    [has_colimit F] [preserves_colimit F G] : reflects_colimit F G :=
  reflects_colimit.mk
    fun (c : cocone F) (t : is_colimit (functor.map_cocone G c)) =>
      is_colimit.of_point_iso (colimit.is_colimit F)

/--
If `C` has colimits of shape `J` and `G` preserves them, then if `G` reflects isomorphisms then it
reflects colimits of shape `J`.
-/
def reflects_colimits_of_shape_of_reflects_isomorphisms {C : Type u₁} [category C] {D : Type u₂}
    [category D] {J : Type v} [small_category J] {G : C ⥤ D} [reflects_isomorphisms G]
    [has_colimits_of_shape J C] [preserves_colimits_of_shape J G] :
...
colimits.
-/
def reflects_colimits_of_reflects_isomorphisms {C : Type u₁} [category C] {D : Type u₂} [category D]
    {G : C ⥤ D} [reflects_isomorphisms G] [has_colimits C] [preserves_colimits G] :
    reflects_colimits G :=
  reflects_colimits.mk
    fun (J : Type v) (𝒥₁ : small_category J) => reflects_colimits_of_shape_of_reflects_isomorphisms

/-- A fully faithful functor reflects limits. -/
def fully_faithful_reflects_limits {C : Type u₁} [category C] {D : Type u₂} [category D] (F : C ⥤ D)
    [full F] [faithful F] : reflects_limits F :=
  reflects_limits.mk
    fun (J : Type v) (𝒥₁ : small_category J) =>
      reflects_limits_of_shape.mk
        fun (K : J ⥤ C) =>
...
def fully_faithful_reflects_colimits {C : Type u₁} [category C] {D : Type u₂} [category D]
    (F : C ⥤ D) [full F] [faithful F] : reflects_colimits F :=
  reflects_colimits.mk
    fun (J : Type v) (𝒥₁ : small_category J) =>
      reflects_colimits_of_shape.mk
        fun (K : J ⥤ C) =>
