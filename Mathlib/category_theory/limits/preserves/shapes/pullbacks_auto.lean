...
-/
def is_limit_map_cone_pullback_cone_equiv {C : Type u₁} [category C] {D : Type u₂} [category D]
    (G : C ⥤ D) {W : C} {X : C} {Y : C} {Z : C} {f : X ⟶ Z} {g : Y ⟶ Z} {h : W ⟶ X} {k : W ⟶ Y}
    (comm : h ≫ f = k ≫ g) :
    is_limit (functor.map_cone G (pullback_cone.mk h k comm)) ≃
        is_limit
          (pullback_cone.mk (functor.map G h) (functor.map G k)
            (is_limit_map_cone_pullback_cone_equiv._proof_1 G comm)) :=
  equiv.trans
    (equiv.symm
...
def is_limit_pullback_cone_map_of_is_limit {C : Type u₁} [category C] {D : Type u₂} [category D]
    (G : C ⥤ D) {W : C} {X : C} {Y : C} {Z : C} {f : X ⟶ Z} {g : Y ⟶ Z} {h : W ⟶ X} {k : W ⟶ Y}
    (comm : h ≫ f = k ≫ g) [preserves_limit (cospan f g) G]
...
def is_limit_of_is_limit_pullback_cone_map {C : Type u₁} [category C] {D : Type u₂} [category D]
    (G : C ⥤ D) {W : C} {X : C} {Y : C} {Z : C} {f : X ⟶ Z} {g : Y ⟶ Z} {h : W ⟶ X} {k : W ⟶ Y}
    (comm : h ≫ f = k ≫ g) [reflects_limit (cospan f g) G]
    (l :
      is_limit
        (pullback_cone.mk (functor.map G h) (functor.map G k)
          (is_limit_map_cone_pullback_cone_equiv._proof_1 G comm))) :
...
-/
def is_limit_of_has_pullback_of_preserves_limit {C : Type u₁} [category C] {D : Type u₂}
    [category D] (G : C ⥤ D) {X : C} {Y : C} {Z : C} (f : X ⟶ Z) (g : Y ⟶ Z) [has_pullback f g]
...
pullback of `(f,g)`.
-/
def preserves_pullback.of_iso_comparison {C : Type u₁} [category C] {D : Type u₂} [category D]
    (G : C ⥤ D) {X : C} {Y : C} {Z : C} (f : X ⟶ Z) (g : Y ⟶ Z) [has_pullback f g]
    [has_pullback (functor.map G f) (functor.map G g)] [i : is_iso (pullback_comparison G f g)] :
    preserves_limit (cospan f g) G :=
...
an isomorphism.
-/
def preserves_pullback.iso {C : Type u₁} [category C] {D : Type u₂} [category D] (G : C ⥤ D) {X : C}
    {Y : C} {Z : C} (f : X ⟶ Z) (g : Y ⟶ Z) [has_pullback f g]
    [has_pullback (functor.map G f) (functor.map G g)] [preserves_limit (cospan f g) G] :
...
@[simp] theorem preserves_pullback.iso_hom {C : Type u₁} [category C] {D : Type u₂} [category D]
    (G : C ⥤ D) {X : C} {Y : C} {Z : C} (f : X ⟶ Z) (g : Y ⟶ Z) [has_pullback f g]
    [has_pullback (functor.map G f) (functor.map G g)] [preserves_limit (cospan f g) G] :
    iso.hom (preserves_pullback.iso G f g) = pullback_comparison G f g :=
  rfl

protected instance pullback_comparison.category_theory.is_iso {C : Type u₁} [category C]
    {D : Type u₂} [category D] (G : C ⥤ D) {X : C} {Y : C} {Z : C} (f : X ⟶ Z) (g : Y ⟶ Z)
    [has_pullback f g] [has_pullback (functor.map G f) (functor.map G g)]
    [preserves_limit (cospan f g) G] : is_iso (pullback_comparison G f g) :=
