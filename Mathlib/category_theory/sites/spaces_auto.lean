...
def grothendieck_topology (T : Type u) [topological_space T] :
    category_theory.grothendieck_topology (topological_space.opens T) :=
...
def pretopology (T : Type u) [topological_space T] :
    category_theory.pretopology (topological_space.opens T) :=
...
-/
@[simp] theorem pretopology_to_grothendieck (T : Type u) [topological_space T] :
    category_theory.pretopology.to_grothendieck (topological_space.opens T) (pretopology T) =
        grothendieck_topology T :=
  sorry
