...
-/
def limit {J : Type v} [category_theory.small_category J] {C : Type u} [category_theory.category C]
    [category_theory.limits.has_limits C] [category_theory.monoidal_category C] (F : J ⥤ Mon_ C) :
    Mon_ C :=
  category_theory.functor.obj
    (category_theory.lax_monoidal_functor.map_Mon category_theory.limits.lim_lax)
    (category_theory.functor.obj category_theory.monoidal.Mon_functor_category_equivalence.inverse
      F)

/--
Implementation of `Mon_.has_limits`: a limiting cone over a functor `F : J ⥤ Mon_ C`.
-/
def limit_cone {J : Type v} [category_theory.small_category J] {C : Type u}
    [category_theory.category C] [category_theory.limits.has_limits C]
    [category_theory.monoidal_category C] (F : J ⥤ Mon_ C) : category_theory.limits.cone F :=
  category_theory.limits.cone.mk (limit F)
    (category_theory.nat_trans.mk
      fun (j : J) => hom.mk (category_theory.limits.limit.π (F ⋙ forget C) j))
...
-/
def forget_map_cone_limit_cone_iso {J : Type v} [category_theory.small_category J] {C : Type u}
    [category_theory.category C] [category_theory.limits.has_limits C]
    [category_theory.monoidal_category C] (F : J ⥤ Mon_ C) :
    category_theory.functor.map_cone (forget C) (limit_cone F) ≅
        category_theory.limits.limit.cone (F ⋙ forget C) :=
...
-/
def limit_cone_is_limit {J : Type v} [category_theory.small_category J] {C : Type u}
    [category_theory.category C] [category_theory.limits.has_limits C]
    [category_theory.monoidal_category C] (F : J ⥤ Mon_ C) :
  ...
  category_theory.limits.is_limit.mk
    fun (s : category_theory.limits.cone F) =>
      hom.mk
        (category_theory.limits.limit.lift (F ⋙ forget C)
          (category_theory.functor.map_cone (forget C) s))

protected instance has_limits {C : Type u} [category_theory.category C]
    [category_theory.limits.has_limits C] [category_theory.monoidal_category C] :
    category_theory.limits.has_limits (Mon_ C) :=
...
protected instance forget_preserves_limits {C : Type u} [category_theory.category C]
    [category_theory.limits.has_limits C] [category_theory.monoidal_category C] :
    category_theory.limits.preserves_limits (forget C) :=
        ...
        fun (F : J ⥤ Mon_ C) =>
          category_theory.limits.preserves_limit_of_preserves_limit_cone (limit_cone_is_limit F)
            (category_theory.limits.is_limit.of_iso_limit
              (category_theory.limits.limit.is_limit (F ⋙ forget C))
