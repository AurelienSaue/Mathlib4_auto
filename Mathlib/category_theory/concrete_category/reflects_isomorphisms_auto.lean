...
protected instance category_theory.forget.category_theory.reflects_isomorphisms :
  ...
  category_theory.reflects_isomorphisms.mk
    fun (X Y : Type u) (f : X ⟶ Y)
      (i :
      category_theory.is_iso (category_theory.functor.map (category_theory.forget (Type u)) f)) =>
      i
...
-/
protected instance category_theory.forget₂.category_theory.reflects_isomorphisms (C : Type (u + 1))
    [category_theory.category C] [category_theory.concrete_category C] (D : Type (u + 1))
